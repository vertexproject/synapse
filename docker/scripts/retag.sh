...
docker tag vertexproject/synapse-ci:${CURRENT_TAG} vertexproject/synapse-ci:${NEW_TAG}
docker tag vertexproject/synapse-ci:${CURRENT_TAG}-browsers vertexproject/synapse-ci:${NEW_TAG}-browsers
