...
class RiskModelTest(s_t_utils.SynTest):
    ...
    async def test_model_risk(self):
        ...
        async with self.getTestCore() as core:
            ...
            self.eq(node.get('time'), 1580601600000000)
            self.eq(node.get('detected'), 1612310400000000)
            ...
            self.nn(node.get('reporter'))
            self.eq(node.get('reporter:name'), 'vertex')
            self.eq(node.get('timeline:exploited'), 1578960000000000)
            self.eq(node.get('timeline:discovered'), 1578960000000000)
            self.eq(node.get('timeline:vendor:notified'), 1578960000000000)
            self.eq(node.get('timeline:vendor:fixed'), 1578960000000000)
            self.eq(node.get('timeline:published'), 1578960000000000)
            ...
            self.eq(1612224000000000, nodes[0].get('time'))
            self.eq(1612310400000000, nodes[0].get('detected'))
            self.eq(1612396800000000, nodes[0].get('lasttime'))
            self.eq(172800000000, nodes[0].get('duration'))
