...
class ModelRevTest(s_tests.SynTest):
    ...
    async def test_modelrev_0_2_27(self):
        ...
        async with self.getRegrCore('model-0.2.27') as core:
            ...
            self.eq(refsq, [
                (0,
                 {'iden': '4aa80ca3a5f7d4d031de7bbb85237c017d68d8ac55c06cdf6bb10cde290be7a2',
                  ...
                  'view': fork00}),
                (1,
                 {'iden': '8687f79ad8c314349a198fd45bc65325263db6662e000f77af96ff5bff96e405',
                ...
                (3,
                 {'iden': badcpe00,
                  ...
                  'view': fork00}),
                (4,
                 {'iden': '3d1cda08a9f6d942d0a32c24f40b097726ed5438ac6ccf7ff97922677a38704d',
                  'refs': ({'iden': '11f7e64a8dd8aa5f2a9b52c0e95783da4b7486452aff74dfcf80814f72507f88',
                            'refinfo': ('it:sec:vuln:scan:result', 'asset', 'ndef', False)},),
                  'view': fork00}),
                (5,
                 {'iden': '7c61dc5a43a4ac5242a9c5c02ce7f54a4658338895602dfe0788356da78dd646',
                ...
                (11,
                 {'iden': '85bfc442d87a64a8e75d4ff2831281fb156317767612eef9b75c271ff162c4d9',
                  ...
                  'view': fork00}),
                (12,
                 {'iden': 'db2140d0e290260e4c91a3242d281ce954ce1d9513372a57dcdf0d18cbd6208e',
                  'refs': ({'iden': 'e3c389c194609a57cde68c21cac8ae1cd18e6a642e332461a3acd19138904239',
                            'refinfo': ('it:sec:vuln:scan:result', 'asset', 'ndef', False)},),
                  'view': fork00}),
                (13,
                 {'iden': '49b9a8f8b5f6432109256b0302e54c2ee9fe69d8997dbb7a6af550ba63483194',
