...
_ParseResults = [
    ...
    'Query: [EditNodeAdd: [AbsProp: test:type10, Const: =, Const: 2], EditPropSet: [RelProp: [Const: strprop], Const: =, Const: 1], CmdOper: [Const: spin, Const: ()], LiftProp: [Const: test:type10], FiltOper: [Const: +, DollarExpr: [RelPropValue: [Const: strprop]]], SetVarOper: [Const: foo, Const: 1], FiltOper: [Const: +, VarValue: [Const: foo]]]',
    ...
    'Query: [EditNodeAdd: [AbsProp: inet:fqdn, Const: =, Const: woot.com], EditNodeAdd: [AbsProp: inet:fqdn, Const: =, Const: vertex.link], EditNodeAdd: [AbsProp: inet:user, Const: =, RelPropValue: [Const: zone]], FiltOper: [Const: +, HasAbsPropCond: [AbsProp: inet:user]]]',
