...
_ParseResults = [
    ...
    'Query: [EditNodeAdd: [AbsProp: test:str, Const: =, Const: abcd], EditPropSet: [RelProp: tick, Const: =, Const: 2015], EditTagAdd: [TagName: cool]]',
    ...
    'Query: [VarSetOper: [Const: bar, Const: 5.5.5.5], EditNodeAdd: [AbsProp: inet:ipv4, Const: =, VarValue: [Const: bar]]]',
    'Query: [VarSetOper: [Const: blah, FuncCall: [VarDeref: [VarValue: [Const: lib], Const: dict], CallArgs: [], CallKwargs: [CallKwarg: [Const: foo, Const: vertex.link]]]], EditNodeAdd: [AbsProp: inet:fqdn, Const: =, VarDeref: [VarValue: [Const: blah], Const: foo]]]',
    ...
    'Query: [EditNodeAdd: [AbsProp: graph:node, Const: =, Const: *], EditPropSet: [RelProp: type, Const: =, Const: m1]]',
    'Query: [EditNodeAdd: [AbsProp: geo:place, Const: =, Const: *], EditPropSet: [RelProp: latlong, Const: =, List: [Const: -30.0, Const: 20.22]]]',
    'Query: [EditNodeAdd: [AbsProp: inet:asn, Const: =, Const: 200], EditPropSet: [RelProp: name, Const: =, Const: visi]]',
    ...
    'Query: [EditNodeAdd: [AbsProp: inet:dns:a, Const: =, List: [Const: vertex.link, Const: 5.5.5.5]], EditTagAdd: [TagName: nope]]',
    'Query: [EditNodeAdd: [AbsProp: inet:dns:a, Const: =, List: [Const: woot.com, Const: 1.2.3.4]]]',
    'Query: [EditNodeAdd: [AbsProp: inet:dns:a, Const: =, List: [Const: woot.com, Const: 1.2.3.4]], EditTagAdd: [TagName: yepr]]',
    ...
    'Query: [EditNodeAdd: [AbsProp: inet:dns:a, Const: =, List: [Const: woot.com, Const: 1.2.3.4]], EditPropSet: [UnivProp: .seen, Const: =, List: [Const: 2015, Const: 2016]]]',
    ...
    'Query: [EditNodeAdd: [AbsProp: inet:fqdn, Const: =, Const: woot.com], EditTagAdd: [TagName: bad, List: [Const: 2015, Const: 2016]]]',
    'Query: [EditNodeAdd: [AbsProp: inet:fqdn, Const: =, Const: woot.com], PivotOut: [], isjoin=False]',
    'Query: [EditNodeAdd: [AbsProp: inet:fqdn, Const: =, Const: woot.com], EditNodeAdd: [AbsProp: inet:fqdn, Const: =, Const: vertex.link], EditNodeAdd: [AbsProp: inet:user, Const: =, RelPropValue: [RelProp: zone]], FiltOper: [Const: +, HasAbsPropCond: [AbsProp: inet:user]]]',
    'Query: [EditNodeAdd: [AbsProp: inet:ipv4, Const: =, Const: 94.75.194.194], EditPropSet: [RelProp: loc, Const: =, Const: nl]]',
    ...
    'Query: [EditNodeAdd: [AbsProp: inet:ipv4, Const: =, Const: 1.2.3.4], EditPropSet: [RelProp: asn, Const: =, Const: 2]]',
    'Query: [EditNodeAdd: [AbsProp: inet:ipv4, Const: =, Const: 1.2.3.4], EditPropSet: [RelProp: loc, Const: =, Const: us], EditNodeAdd: [AbsProp: inet:dns:a, Const: =, List: [Const: vertex.link, Const: 1.2.3.4]]]',
    'Query: [EditNodeAdd: [AbsProp: inet:ipv4, Const: =, Const: 1.2.3.4]]',
    'Query: [EditNodeAdd: [AbsProp: inet:ipv4, Const: =, Const: 192.168.1.0/24]]',
    'Query: [EditNodeAdd: [AbsProp: inet:ipv4, Const: =, Const: 4.3.2.1], EditPropSet: [RelProp: loc, Const: =, Const: zz], EditNodeAdd: [AbsProp: inet:dns:a, Const: =, List: [Const: example.com, Const: 4.3.2.1]]]',
    'Query: [EditNodeAdd: [AbsProp: inet:ipv4, Const: =, Const: 197.231.221.211], EditPropSet: [RelProp: asn, Const: =, Const: 37560], EditPropSet: [RelProp: loc, Const: =, Const: lr.lo.voinjama], EditPropSet: [RelProp: latlong, Const: =, Const: 8.4219,-9.7478], EditPropSet: [RelProp: dns:rev, Const: =, Const: exit1.ipredator.se], EditTagAdd: [TagName: cno.anon.tor.exit, List: [Const: 2017/12/19, Const: 2019/02/15]]]',
    'Query: [EditNodeAdd: [AbsProp: inet:user, Const: =, Const: visi], EditNodeAdd: [AbsProp: inet:user, Const: =, Const: whippit]]',
    'Query: [EditNodeAdd: [AbsProp: test:comp, Const: =, List: [Const: 10, Const: haha]], EditTagAdd: [TagName: foo.bar], EditTagDel: [TagName: foo.bar]]',
    ...
    'Query: [EditNodeAdd: [AbsProp: test:guid, Const: =, Const: *], EditPropSet: [RelProp: tick, Const: =, Const: 2015]]',
    'Query: [EditNodeAdd: [AbsProp: test:guid, Const: =, Const: *], EditPropSet: [RelProp: tick, Const: =, Const: 2016]]',
    'Query: [EditNodeAdd: [AbsProp: test:guid, Const: =, Const: *], EditPropSet: [RelProp: tick, Const: =, Const: 2017]]',
    'Query: [EditNodeAdd: [AbsProp: test:pivcomp, Const: =, List: [Const: foo, Const: bar]], EditPropSet: [RelProp: tick, Const: =, Const: 2018]]',
    'Query: [EditNodeAdd: [AbsProp: test:pivcomp, Const: =, List: [Const: foo, Const: bar]]]',
    'Query: [EditNodeAdd: [AbsProp: test:pivcomp, Const: =, List: [Const: hehe, Const: haha]], EditPropSet: [RelProp: tick, Const: =, Const: 2015], EditTagAdd: [TagName: foo, List: [Const: 2014, Const: 2016]]]',
    'Query: [EditNodeAdd: [AbsProp: test:pivcomp, Const: =, List: [Const: xxx, Const: yyy]], EditPropSet: [RelProp: width, Const: =, Const: 42]]',
    'Query: [EditNodeAdd: [AbsProp: test:str, Const: =, Const: foo bar], EditPropSet: [RelProp: tick, Const: =, Const: 2018]]',
    'Query: [EditNodeAdd: [AbsProp: test:str, Const: =, Const: bar], EditTagAdd: [TagName: baz]]',
    ...
    'Query: [EditNodeAdd: [AbsProp: test:str, Const: =, Const: foo], EditTagAdd: [TagName: bar], FiltOper: [Const: +, OrCond: [TagCond: [TagMatch: baz], NotCond: [HasRelPropCond: [UnivProp: .seen]]]]]',
    'Query: [EditNodeAdd: [AbsProp: test:str, Const: =, Const: foo], EditTagAdd: [TagName: bar], FiltOper: [Const: +, NotCond: [HasRelPropCond: [UnivProp: .seen]]]]',
    'Query: [EditNodeAdd: [AbsProp: test:str, Const: =, Const: foo], EditTagAdd: [TagName: bar], SubQuery: [Query: [EditTagAdd: [TagName: baz], FiltOper: [Const: -, TagCond: [TagMatch: bar]]]]]',
    "Query: [EditNodeAdd: [AbsProp: test:str, Const: =, Const: foo], EditNodeAdd: [AbsProp: test:str, Const: =, Const: bar], CmdOper: [Const: sleep, Const: ('10',)]]",
    ...
    'Query: [EditNodeAdd: [AbsProp: test:str, Const: =, Const: haha], EditTagAdd: [TagName: bar, Const: 2015]]',
    'Query: [EditNodeAdd: [AbsProp: test:str, Const: =, Const: haha], EditTagAdd: [TagName: foo]]',
    'Query: [EditNodeAdd: [AbsProp: test:str, Const: =, Const: hehe], EditTagAdd: [TagName: foo, List: [Const: 2014, Const: 2016]]]',
    'Query: [EditNodeAdd: [AbsProp: test:str, Const: =, Const: hehe]]',
    'Query: [EditNodeAdd: [AbsProp: test:str, Const: =, Const: oof], EditTagAdd: [TagName: bar], SubQuery: [Query: [EditNodeAdd: [AbsProp: test:int, Const: =, Const: 0xdeadbeef]]]]',
    'Query: [EditNodeAdd: [AbsProp: test:str, Const: =, Const: visi], EditTagAdd: [TagName: foo.bar], PivotToTags: [TagMatch: ], isjoin=False, EditTagAdd: [TagName: baz.faz]]',
    'Query: [EditNodeAdd: [AbsProp: test:str, Const: =, Const: visi], EditTagAdd: [TagName: foo.bar], PivotToTags: [TagMatch: ], isjoin=False]',
    'Query: [EditNodeAdd: [AbsProp: test:str, Const: =, Const: visi], EditNodeAdd: [AbsProp: test:int, Const: =, Const: 20], EditTagAdd: [TagName: foo.bar]]',
    'Query: [EditNodeAdd: [AbsProp: test:str, Const: =, Const: woot], EditTagAdd: [TagName: foo, List: [Const: 2015, Const: 2018]], EditTagAdd: [TagName: bar], EditPropSet: [UnivProp: .seen, Const: =, List: [Const: 2014, Const: 2016]]]',
    'Query: [EditNodeAdd: [AbsProp: test:str, Const: =, Const: woot], EditTagAdd: [TagName: foo, List: [Const: 2015, Const: 2018]], EditPropSet: [UnivProp: .seen, Const: =, List: [Const: 2014, Const: 2016]]]',
    'Query: [EditNodeAdd: [AbsProp: test:str, Const: =, Const: woot], EditTagAdd: [TagName: foo, List: [Const: 2015, Const: 2018]]]',
    'Query: [EditNodeAdd: [AbsProp: test:str, Const: =, Const: woot], EditPropSet: [UnivProp: .seen, Const: =, List: [Const: 2014, Const: 2015]]]',
    'Query: [EditNodeAdd: [AbsProp: test:str, Const: =, Const: woot], EditPropSet: [UnivProp: .seen, Const: =, Const: 20]]',
    ...
    'Query: [EditNodeAdd: [AbsProp: inet:ipv4, Const: =, Const: 1.2.3.4], EditPropSet: [RelProp: asn, Const: =, Const: 10], EditNodeAdd: [AbsProp: meta:seen, Const: =, List: [Const: abcd, List: [Const: inet:asn, Const: 10]]]]',
    'Query: [EditNodeAdd: [AbsProp: meta:seen, Const: =, List: [Const: abcd, List: [Const: test:str, Const: pennywise]]]]',
    'Query: [EditNodeAdd: [AbsProp: meta:source, Const: =, Const: abcd], EditTagAdd: [TagName: omit.nopiv], EditNodeAdd: [AbsProp: meta:seen, Const: =, List: [Const: abcd, List: [Const: test:pivtarg, Const: foo]]]]',
    'Query: [EditNodeAdd: [AbsProp: test:comp, Const: =, List: [Const: 1234, Const: 5678]]]',
    'Query: [EditNodeAdd: [AbsProp: test:comp, Const: =, List: [Const: 3, Const: foob]], EditTagAdd: [TagName: meep.gorp], EditTagAdd: [TagName: bleep.zlorp], EditTagAdd: [TagName: cond]]',
    'Query: [EditNodeAdd: [AbsProp: test:guid, Const: =, Const: *], EditPropSet: [RelProp: tick, Const: =, Const: 2001]]',
    'Query: [EditNodeAdd: [AbsProp: test:guid, Const: =, Const: abcd], EditPropSet: [RelProp: tick, Const: =, Const: 2015]]',
    ...
    'Query: [EditNodeAdd: [AbsProp: test:int, Const: =, Const: 10], EditPropSet: [RelProp: loc, Const: =, Const: us.va]]',
    'Query: [EditNodeAdd: [AbsProp: test:int, Const: =, Const: 2], EditPropSet: [RelProp: loc, Const: =, Const: us.va.sydney]]',
    'Query: [EditNodeAdd: [AbsProp: test:int, Const: =, Const: 20]]',
    'Query: [EditNodeAdd: [AbsProp: test:int, Const: =, Const: 3], EditPropSet: [RelProp: loc, Const: =, Const: ]]',
    'Query: [EditNodeAdd: [AbsProp: test:int, Const: =, Const: 4], EditPropSet: [RelProp: loc, Const: =, Const: us.va.fairfax]]',
    'Query: [EditNodeAdd: [AbsProp: test:int, Const: =, Const: 9], EditPropSet: [RelProp: loc, Const: =, Const: us.ओं]]',
    ...
    'Query: [EditNodeAdd: [AbsProp: test:str, Const: =, Const: a], SwitchCase: [VarValue: [Const: woot], CaseEntry: [Const: hehe, SubQuery: [Query: [EditTagAdd: [TagName: baz]]]]]]',
    'Query: [EditNodeAdd: [AbsProp: test:str, Const: =, Const: beep], EditNodeAdd: [AbsProp: test:str, Const: =, Const: boop]]',
    'Query: [EditNodeAdd: [AbsProp: test:str, Const: =, Const: c], SwitchCase: [VarValue: [Const: woot], CaseEntry: [Const: hehe, SubQuery: [Query: [EditTagAdd: [TagName: baz]]]], CaseEntry: [SubQuery: [Query: [EditTagAdd: [TagName: jaz]]]]]]',
    'Query: [EditNodeAdd: [AbsProp: test:str, Const: =, Const: c], SwitchCase: [VarValue: [Const: woot], CaseEntry: [Const: hehe, SubQuery: [Query: [EditTagAdd: [TagName: baz]]]], CaseEntry: [Const: haha hoho, SubQuery: [Query: [EditTagAdd: [TagName: faz]]]], CaseEntry: [Const: lolz:lulz, SubQuery: [Query: [EditTagAdd: [TagName: jaz]]]]]]',
    'Query: [EditNodeAdd: [AbsProp: test:str, Const: =, Const: foo], EditPropSet: [RelProp: tick, Const: =, Const: 201808021201]]',
    ...
    'Query: [LiftPropBy: [Const: inet:dns:a, Const: =, List: [Const: woot.com, Const: 12.34.56.78]], EditPropSet: [UnivProp: .seen, Const: =, List: [Const: 201708010123, Const: 201708100456]]]',
    'Query: [LiftPropBy: [Const: inet:dns:a, Const: =, List: [Const: woot.com, Const: 12.34.56.78]], EditPropSet: [UnivProp: .seen, Const: =, List: [Const: 201708010123, Const: ?]]]',
    ...
    'Query: [LiftPropBy: [Const: inet:dns:a, Const: =, List: [Const: woot.com, Const: 1.2.3.4]], VarSetOper: [Const: seen, UnivPropValue: [UnivProp: .seen]], PropPivot: [RelPropValue: [RelProp: fqdn], AbsProp: inet:fqdn], isjoin=False, EditPropSet: [UnivProp: .seen, Const: =, VarValue: [Const: seen]]]',
    'Query: [LiftPropBy: [Const: inet:dns:a, Const: =, List: [Const: woot.com, Const: 1.2.3.4]], EditPropSet: [UnivProp: .seen, Const: =, List: [Const: 2015, Const: 2018]]]',
    ...
    'Query: [LiftPropBy: [Const: inet:ipv4, Const: =, Const: 12.34.56.78], EditPropSet: [RelProp: loc, Const: =, Const: us.oh.wilmington]]',
    'Query: [LiftPropBy: [Const: inet:ipv4, Const: =, Const: 12.34.56.78], LiftPropBy: [Const: inet:fqdn, Const: =, Const: woot.com], EditNodeAdd: [AbsProp: inet:ipv4, Const: =, Const: 1.2.3.4], EditPropSet: [RelProp: asn, Const: =, Const: 10101], EditNodeAdd: [AbsProp: inet:fqdn, Const: =, Const: woowoo.com], EditTagAdd: [TagName: my.tag]]',
    ...
    'Query: [LiftPropBy: [Const: media:news, Const: =, Const: 00a1f0d928e25729b9e86e2d08c127ce], EditPropSet: [RelProp: summary, Const: =, Const: ]]',
    ...
    'Query: [CmdOper: [Const: sudo, Const: ()], EditNodeAdd: [AbsProp: test:cycle0, Const: =, Const: foo], EditPropSet: [RelProp: test:cycle1, Const: =, Const: bar]]',
    'Query: [CmdOper: [Const: sudo, Const: ()], EditNodeAdd: [AbsProp: test:guid, Const: =, Const: *]]',
    'Query: [CmdOper: [Const: sudo, Const: ()], EditNodeAdd: [AbsProp: test:str, Const: =, Const: foo], EditTagAdd: [TagName: lol]]',
    'Query: [CmdOper: [Const: sudo, Const: ()], EditNodeAdd: [AbsProp: test:str, Const: =, Const: foo]]',
    'Query: [CmdOper: [Const: sudo, Const: ()], EditNodeAdd: [AbsProp: test:str, Const: =, Const: 123], EditPropSet: [RelProp: tick, Const: =, Const: 2018]]',
    ...
    'Query: [LiftPropBy: [Const: test:pivtarg, Const: =, Const: hehe], EditPropSet: [UnivProp: .seen, Const: =, Const: 2015]]',
    ...
    'Query: [LiftPropBy: [Const: test:str, Const: =, Const: 123], EditPropSet: [RelProp: baz, Const: =, Const: test:guid:tick=2015]]',
    ...
    'Query: [LiftPropBy: [Const: test:str, Const: =, Const: hello], EditPropSet: [RelProp: tick, Const: =, Const: 2001]]',
    'Query: [LiftPropBy: [Const: test:str, Const: =, Const: hello], EditPropSet: [RelProp: tick, Const: =, Const: 2002]]',
    ...
    'Query: [LiftProp: [Const: test:int]]',
    'Query: [LiftProp: [Const: test:int]]',
    'Query: [EditNodeAdd: [AbsProp: inet:ipv4, Const: =, Const: 1.2.3.4], SwitchCase: [VarValue: [Const: foo], CaseEntry: [Const: bar, SubQuery: [Query: [EditTagAdd: [TagName: hehe.haha]]]], CaseEntry: [Const: baz faz, SubQuery: [Query: []]]]]',
    ...
    'Query: [ForLoop: [Const: foo, VarValue: [Const: foos], SubQuery: [Query: [EditNodeAdd: [AbsProp: inet:ipv4, Const: =, Const: 1.2.3.4], SwitchCase: [VarValue: [Const: foo], CaseEntry: [Const: bar, SubQuery: [Query: [EditTagAdd: [TagName: ohai], BreakOper: []]]], CaseEntry: [Const: baz, SubQuery: [Query: [EditTagAdd: [TagName: visi], ContinueOper: []]]]], EditNodeAdd: [AbsProp: inet:ipv4, Const: =, Const: 5.6.7.8], EditTagAdd: [TagName: hehe]]]]]',
    "Query: [ForLoop: [Const: foo, VarValue: [Const: foos], SubQuery: [Query: [VarListSetOper: [VarList: ['fqdn', 'ipv4'], FuncCall: [VarDeref: [VarValue: [Const: foo], Const: split], CallArgs: [Const: |], CallKwargs: []]], EditNodeAdd: [AbsProp: inet:dns:a, Const: =, List: [VarValue: [Const: fqdn], VarValue: [Const: ipv4]]]]]]]",
    ...
    'Query: [EditNodeAdd: [AbsProp: inet:email:message, Const: =, Const: *], EditPropSet: [RelProp: to, Const: =, Const: woot@woot.com], EditPropSet: [RelProp: from, Const: =, Const: visi@vertex.link], EditPropSet: [RelProp: replyto, Const: =, Const: root@root.com], EditPropSet: [RelProp: subject, Const: =, Const: hi there], EditPropSet: [RelProp: date, Const: =, Const: 2015], EditPropSet: [RelProp: body, Const: =, Const: there are mad sploitz here!], EditPropSet: [RelProp: bytes, Const: =, Const: *], SubQuery: [Query: [EditNodeAdd: [AbsProp: inet:email:message:link, Const: =, List: [VarValue: [Const: node], Const: https://www.vertex.link]]]], SubQuery: [Query: [EditNodeAdd: [AbsProp: inet:email:message:attachment, Const: =, List: [VarValue: [Const: node], Const: *]], FiltOper: [Const: -, HasAbsPropCond: [AbsProp: inet:email:message]], EditPropSet: [RelProp: name, Const: =, Const: sploit.exe]]], SubQuery: [Query: [EditNodeAdd: [AbsProp: edge:has, Const: =, List: [VarValue: [Const: node], List: [Const: inet:email:header, List: [Const: to, Const: Visi Kensho <visi@vertex.link>]]]]]]]',
