...
Queries = [
    ...
    '[test:str=foo :tick*min=2019]',
    '[test:str=foo :tick*max?=2019]',
    '[test:str=foo :seen.max*max=2019]',
    '[test:str=foo +?#(foo.bar).max*max=2019]',
...
_ParseResults = [
    ...
    'Query: [EditNodeAdd: [FormName: [Const: test:str], Const: =, Const: foo], EditCondPropSet: [RelProp: [Const: tick], CondSetOper: [Const: min], Const: 2019]]',
    'Query: [EditNodeAdd: [FormName: [Const: test:str], Const: =, Const: foo], EditCondPropSet: [RelProp: [Const: tick], CondSetOper: [Const: max], Const: 2019]]',
    'Query: [EditNodeAdd: [FormName: [Const: test:str], Const: =, Const: foo], EditVirtCondPropSet: [RelProp: [Const: seen], VirtProp: [Const: max], CondSetOper: [Const: max], Const: 2019]]',
    'Query: [EditNodeAdd: [FormName: [Const: test:str], Const: =, Const: foo], EditTagVirtCondSet: [TagName: [Const: foo, Const: bar], VirtProp: [Const: max], CondSetOper: [Const: max], Const: 2019]]',
