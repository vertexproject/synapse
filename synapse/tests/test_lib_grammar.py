...
_ParseResults = [
    ...
    'Query: [EditNodeAdd: [FormName: [Const: test:str], Const: =, Const: c], SwitchCase: [VarValue: [Const: woot], CaseEntry: [Const: hehe, SubQuery: [Query: [EditTagAdd: [TagName: [Const: baz]]]]], CaseEntry: [Const: *, SubQuery: [Query: [EditTagAdd: [TagName: [Const: jaz]]]]]]]',
    ...
    'Query: [SwitchCase: [VarValue: [Const: category]], SwitchCase: [VarValue: [Const: type], CaseEntry: [Const: *, SubQuery: [Query: []]]]]',
