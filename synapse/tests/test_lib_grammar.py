...
_ParseResults = [
    ...
    'Query: [EditNodeAdd: [FormName: [Const: test:str], Const: =, Const: a], SwitchCase: [FuncCall: [VarDeref: [VarValue: [Const: node], Const: form], CallArgs: [], CallKwargs: []], CaseEntry: [CaseMatch: [Const: hehe], SubQuery: [Query: [EditTagAdd: [TagName: [Const: baz]]]]]]]',
    ...
    'Query: [EditNodeAdd: [FormName: [Const: test:str], Const: =, Const: a], SwitchCase: [FuncCall: [VarDeref: [VarValue: [Const: node], Const: form], CallArgs: [], CallKwargs: []], CaseEntry: [CaseMatch: [Const: hehe], SubQuery: [Query: [EditTagAdd: [TagName: [Const: baz]]]]]]]',
    'Query: [EditNodeAdd: [FormName: [Const: test:str], Const: =, Const: a], SwitchCase: [VarValue: [Const: woot], CaseEntry: [CaseMatch: [Const: hehe], SubQuery: [Query: [EditTagAdd: [TagName: [Const: baz]]]]]]]',
    'Query: [EditNodeAdd: [FormName: [Const: test:str], Const: =, Const: c], SwitchCase: [VarValue: [Const: woot], CaseEntry: [CaseMatch: [Const: hehe], SubQuery: [Query: [EditTagAdd: [TagName: [Const: baz]]]]], CaseEntry: [CaseMatch: [Const: *], SubQuery: [Query: [EditTagAdd: [TagName: [Const: jaz]]]]]]]',
    'Query: [EditNodeAdd: [FormName: [Const: test:str], Const: =, Const: c], SwitchCase: [VarValue: [Const: woot], CaseEntry: [CaseMatch: [Const: hehe], SubQuery: [Query: [EditTagAdd: [TagName: [Const: baz]]]]], CaseEntry: [CaseMatch: [Const: haha hoho], SubQuery: [Query: [EditTagAdd: [TagName: [Const: faz]]]]], CaseEntry: [CaseMatch: [Const: lolz:lulz], SubQuery: [Query: [EditTagAdd: [TagName: [Const: jaz]]]]]]]',
    'Query: [EditNodeAdd: [FormName: [Const: inet:ipv4], Const: =, Const: 1.2.3.4], SwitchCase: [VarValue: [Const: foo], CaseEntry: [CaseMatch: [Const: bar], SubQuery: [Query: [EditTagAdd: [TagName: [Const: hehe, Const: haha]]]]], CaseEntry: [CaseMatch: [Const: baz faz], SubQuery: [Query: []]]]]',

    'Query: [ForLoop: [Const: foo, VarValue: [Const: foos], SubQuery: [Query: [EditNodeAdd: [FormName: [Const: inet:ipv4], Const: =, Const: 1.2.3.4], SwitchCase: [VarValue: [Const: foo], CaseEntry: [CaseMatch: [Const: bar], SubQuery: [Query: [EditTagAdd: [TagName: [Const: ohai]], BreakOper: []]]], CaseEntry: [CaseMatch: [Const: baz], SubQuery: [Query: [EditTagAdd: [TagName: [Const: visi]], ContinueOper: []]]], CaseEntry: [CaseMatch: [Const: far, Const: faz], SubQuery: [Query: [EditTagAdd: [TagName: [Const: multi, Const: far]], ContinueOper: []]]], CaseEntry: [CaseMatch: [Const: gar, Const: gaz], SubQuery: [Query: [EditTagAdd: [TagName: [Const: multi, Const: gar]], ContinueOper: []]]], CaseEntry: [CaseMatch: [Const: har, Const: haz], SubQuery: [Query: [EditTagAdd: [TagName: [Const: multi, Const: har]], ContinueOper: []]]], CaseEntry: [CaseMatch: [Const: kar, Const: kaz, Const: koo], SubQuery: [Query: [EditTagAdd: [TagName: [Const: multi, Const: kar]], ContinueOper: []]]]], EditNodeAdd: [FormName: [Const: inet:ipv4], Const: =, Const: 5.6.7.8], EditTagAdd: [TagName: [Const: hehe]]]]]]',

    'Query: [SwitchCase: [VarValue: [Const: a], CaseEntry: [CaseMatch: [Const: a], SubQuery: [Query: []]]]]',
    'Query: [SwitchCase: [VarValue: [Const: a], CaseEntry: [CaseMatch: [Const: test:str], SubQuery: [Query: []]], CaseEntry: [CaseMatch: [Const: *], SubQuery: [Query: []]]]]',
    'Query: [SwitchCase: [VarValue: [Const: a], CaseEntry: [CaseMatch: [Const: test:this:works:], SubQuery: [Query: []]], CaseEntry: [CaseMatch: [Const: *], SubQuery: [Query: []]]]]',
    'Query: [SwitchCase: [VarValue: [Const: a], CaseEntry: [CaseMatch: [Const: single:quotes], SubQuery: [Query: []]], CaseEntry: [CaseMatch: [Const: doubele:quotes], SubQuery: [Query: []]], CaseEntry: [CaseMatch: [Const: noquotes], SubQuery: [Query: []]], CaseEntry: [CaseMatch: [Const: *], SubQuery: [Query: []]]]]',
    'Query: [SwitchCase: [VarValue: [Const: category]], SwitchCase: [VarValue: [Const: type], CaseEntry: [CaseMatch: [Const: *], SubQuery: [Query: []]]]]',
