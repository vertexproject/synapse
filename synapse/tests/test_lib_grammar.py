...
_ParseResults = [
    ...
    'Query: [EditNodeAdd: [FormName: [Const: inet:ip], Const: =, Const: 1.2.3.4], EditPropSet: [RelProp: [Const: asn], Const: =, Const: 1], Return: [DollarExpr: [ExprNode: [RelPropValue: [Const: asn], Const: <, ExprNode: [DollarExpr: [Const: 4], Const: -, DollarExpr: [Const: 1]]]]]]',
    'Query: [SetVarOper: [Const: p, Const: asn], LiftPropBy: [Const: inet:ip, Const: =, Const: 1.2.3.4], Return: [DollarExpr: [ExprNode: [RelPropValue: [VarValue: [Const: p]], Const: <, ExprNode: [DollarExpr: [Const: 4], Const: -, DollarExpr: [Const: 1]]]]]]',
    'Query: [EditNodeAdd: [FormName: [Const: inet:ip], Const: =, Const: 1.2.3.4], EditPropSet: [UnivProp: [Const: .test:univ], Const: =, Const: 0], Return: [DollarExpr: [ExprNode: [UnivPropValue: [Const: .test:univ], Const: <, ExprNode: [DollarExpr: [Const: 4], Const: -, DollarExpr: [Const: 1]]]]]]',
    ...
    'Query: [LiftPropBy: [Const: geo:place, Const: =, Const: abcd], SetVarOper: [Const: latlong, RelPropValue: [Const: latlong]], SetVarOper: [Const: radius, RelPropValue: [Const: radius]], CmdOper: [Const: spin, Const: ()], LiftPropBy: [Const: tel:mob:telem:latlong, ByNameCmpr: near=, List: [VarValue: [Const: latlong], Const: 3km]]]',
    ...
    'Query: [LiftPropBy: [Const: inet:ip, Const: =, Const: 1], SetVarOper: [Const: foo, UnivPropValue: [UnivProp: [Const: .created]]], SetVarOper: [Const: bar, DollarExpr: [ExprNode: [VarValue: [Const: foo], Const: +, Const: 1]]]]',
    ...
    'Query: [LiftPropBy: [Const: inet:ip, Const: =, Const: 1.2.3.4], FiltOper: [Const: +, DollarExpr: [ExprNode: [ExprNode: [RelPropValue: [Const: asn], Const: +, Const: 20], Const: >=, Const: 42]]]]',
