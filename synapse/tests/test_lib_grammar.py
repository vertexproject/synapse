...
Queries = [
    ...
    'inet:fqdn=foo.com :zone -> inet:dns*',
    'inet:fqdn=foo.com :zone -> inet:dns:*',
    'inet:fqdn=foo.com :zone -> (edge:has, inet:dns:a)',
    'inet:fqdn=foo.com :zone -> (edge:has, inet:dns*)',
...
_ParseResults = [
    ...
    'Query: [LiftPropBy: [Const: test:str, Const: =, Const: foobar], N1Walk: [Const: refs, Const: inet:dns:*]]',
    'Query: [LiftPropBy: [Const: inet:fqdn, Const: =, Const: foo.com], PropPivot: [RelPropValue: [RelProp: [Const: zone]], Const: inet:dns*], isjoin=False]',
    'Query: [LiftPropBy: [Const: inet:fqdn, Const: =, Const: foo.com], PropPivot: [RelPropValue: [RelProp: [Const: zone]], Const: inet:dns:*], isjoin=False]',
    ...
    'Query: [LiftPropBy: [Const: inet:fqdn, Const: =, Const: foo.com], PropPivot: [RelPropValue: [RelProp: [Const: zone]], List: [Const: edge:has, Const: inet:dns*]], isjoin=False]',
    ...
    'Query: [LiftPropBy: [Const: inet:fqdn, Const: =, Const: foo.com], PropPivot: [RelPropValue: [RelProp: [Const: zone]], Const: inet:dns*], isjoin=True]',
    'Query: [LiftPropBy: [Const: inet:fqdn, Const: =, Const: foo.com], PropPivot: [RelPropValue: [RelProp: [Const: zone]], Const: inet:dns:*], isjoin=True]',
    ...
    'Query: [LiftPropBy: [Const: inet:fqdn, Const: =, Const: foo.com], PropPivot: [RelPropValue: [RelProp: [Const: zone]], List: [Const: edge:has, Const: inet:dns*]], isjoin=True]',
