...
Queries = [
    ...
    'media:news=0c7f7267d3b62432cb0d7d0e9d3108a4 -(refs)> inet:ip',
    '$foo=(2) return(($foo+(1)))',
    '$foo=(2) return(($foo-(1)))',
    'return(((2)+(1)))',
    'return(((2)-(1)))',
    ...
    '$refs = refs media:news <($refs)- (inet:ip,inet:ip) -(#foo or #bar)',
...
_ParseResults = [
    ...
    'Query: [SetVarOper: [Const: foo, DollarExpr: [UnaryExprNode: [Const: -, RelPropValue: [UnivProp: [Const: .foo]]]]]]',
    ...
    'Query: [LiftTagProp: [TagProp: [TagName: [VarValue: [Const: tag]], VarValue: [Const: tagprop]], Cmpr: =, VarValue: [Const: valu]]]',
    'Query: [EditTagPropSet: [TagProp: [TagName: [VarValue: [Const: tag]], VarValue: [Const: tagprop]], Const: =, VarValue: [Const: valu]]]',
    'Query: [VarEvalOper: [FuncCall: [VarDeref: [VarValue: [Const: lib], Const: print], CallArgs: [FormatString: [Const: ip=, FuncCall: [VarDeref: [VarValue: [Const: node], Const: repr], CallArgs: [], CallKwargs: []], Const:  asn=, RelPropValue: [RelProp: [Const: asn]], Const:  .seen=, RelPropValue: [UnivProp: [Const: .seen]], Const:  foo=, TagValue: [TagName: [Const: foo]], Const:  , ExprNode: [RelPropValue: [RelProp: [Const: asn]], Const: =, Const: 5]]], CallKwargs: []]]]',
    'Query: [LiftPropBy: [Const: inet:ip, Cmpr: =, Const: 45.79.131.138], FormPivot: [PivotTarget: [Const: inet:flow]], isjoin=False, FiltOper: [Const: -, OrCond: [RelPropCond: [RelPropValue: [RelProp: [Const: dst:port]], Cmpr: =, Const: 444], RelPropCond: [RelPropValue: [RelProp: [Const: dst:port]], Cmpr: =, Const: 80]]]]',
    'Query: [LiftPropBy: [Const: media:news, Cmpr: =, Const: 0c7f7267d3b62432cb0d7d0e9d3108a4], N1Walk: [Const: refs, Const: inet:ip], isjoin=False]',
    ...
    'Query: [SetVarOper: [Const: p, Const: asn], LiftPropBy: [Const: inet:ip, Cmpr: =, Const: 1.2.3.4], Return: [DollarExpr: [ExprNode: [RelPropValue: [RelProp: [VarValue: [Const: p]]], Const: <, ExprNode: [DollarExpr: [Const: 4], Const: -, DollarExpr: [Const: 1]]]]]]',
    'Query: [EditNodeAdd: [FormName: [Const: inet:ip], Const: =, Const: 1.2.3.4], EditPropSet: [UnivProp: [Const: .test:univ], Const: =, Const: 0], Return: [DollarExpr: [ExprNode: [RelPropValue: [UnivProp: [Const: .test:univ]], Const: <, ExprNode: [DollarExpr: [Const: 4], Const: -, DollarExpr: [Const: 1]]]]]]',
    ...
    'Query: [EditNodeAdd: [FormName: [Const: inet:asn], Const: =, Const: 1], EditNodeAdd: [FormName: [Const: inet:asn], Const: =, Const: 2], EditEdgeAdd: [Const: foo), SubQuery: [Query: [LiftPropBy: [Const: inet:ip, Cmpr: =, Const: 1.2.3.4]]]]]',
    'Query: [LiftPropBy: [Const: inet:asn, Cmpr: <, DollarExpr: [Const: 2]]]',
    ...
    'Query: [TryCatch: [Query: [LiftPropBy: [Const: inet:ip, Cmpr: =, Const: asdf]], CatchBlock: [Const: TypeError, Const: err, Query: []]]]',
    'Query: [TryCatch: [Query: [LiftPropBy: [Const: inet:ip, Cmpr: =, Const: asdf]], CatchBlock: [Const: FooBar, Const: err, Query: []], CatchBlock: [Const: *, Const: err, Query: []]]]',
    'Query: [LiftByArray: [Const: test:array, Cmpr: =, Const: 1.2.3.4]]',
    ...
    'Query: [LiftPropBy: [Const: inet:fqdn, Cmpr: =, Const: newp.com], CmdOper: [Const: tee, List: [ArgvQuery: [Query: [LiftProp: [Const: inet:fqdn]]]]], CmdOper: [Const: uniq, Const: ()]]',
    'Query: [LiftPropBy: [Const: inet:fqdn, Cmpr: =, Const: newp.com], CmdOper: [Const: tee, List: [ArgvQuery: [Query: [LiftProp: [Const: inet:fqdn]]]]], CmdOper: [Const: uniq, Const: ()]]',
    ...
    'Query: [LiftPropBy: [Const: inet:fqdn, Cmpr: =, Const: woot.com], EditEdgeAdd: [Const: refs, SubQuery: [Query: [LiftProp: [Const: media:news]]]]]',
    'Query: [LiftPropBy: [Const: inet:fqdn, Cmpr: =, Const: woot.com], EditEdgeAdd: [Const: refs, SubQuery: [Query: [LiftProp: [Const: media:news]]]]]',
    ...
    'Query: [SetVarOper: [Const: refs, Const: refs], LiftProp: [Const: media:news], N2Walk: [VarValue: [Const: refs], List: [Const: inet:ip, Const: inet:ip]], isjoin=False, FiltOper: [Const: -, OrCond: [TagCond: [TagMatch: [Const: foo]], TagCond: [TagMatch: [Const: bar]]]]]',
    ...
    'Query: [LiftProp: [Const: media:news], EditEdgeDel: [Const: refs, SubQuery: [Query: [LiftPropBy: [Const: inet:fqdn, Cmpr: =, Const: woot.com]]]]]',
    'Query: [LiftProp: [Const: media:news], EditEdgeAdd: [Const: refs, SubQuery: [Query: [LiftPropBy: [Const: inet:fqdn, Cmpr: =, Const: woot.com]]]]]',
    ...
    'Query: [LiftProp: [Const: test:str], SetVarOper: [Const: var, Const: tag1], FiltOper: [Const: +, TagValuCond: [TagMatch: [Const: base, VarValue: [Const: var]], Cmpr: @=, Const: 2014]]]',
    ...
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foo], SetVarOper: [Const: var, Const: hehe], PropPivot: [RelPropValue: [RelProp: [VarValue: [Const: var]]], PivotTarget: [Const: test:str]], isjoin=False]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foo], SetVarOper: [Const: var, Const: seen], EditPropSet: [UnivProp: [VarValue: [Const: var]], Const: =, Const: 2019]]',
    'Query: [LiftProp: [Const: test:str], SetVarOper: [Const: var, Const: seen], FiltOper: [Const: +, HasRelPropCond: [UnivProp: [VarValue: [Const: var]]]]]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foo], SetVarOper: [Const: var, Const: seen], EditUnivDel: [UnivProp: [VarValue: [Const: var]]], CmdOper: [Const: spin, Const: ()], LiftPropBy: [Const: test:str, Cmpr: =, Const: foo]]',
    ...
    'Query: [FiltOper: [Const: +, AbsPropCond: [Const: syn:tag, Cmpr: ~=, Const: aka.*.mal.*]]]',
    'Query: [FiltOper: [Const: +, OrCond: [OrCond: [AbsPropCond: [Const: syn:tag, Cmpr: ^=, Const: aka], AbsPropCond: [Const: syn:tag, Cmpr: ^=, Const: cno]], AbsPropCond: [Const: syn:tag, Cmpr: ^=, Const: rep]]]]',
    ...
    'Query: [SubQuery: [Query: [LiftTag: [TagName: [Const: baz]]]], LiftPropBy: [Const: test:str, Cmpr: =, Const: foo]]',
    ...
    "Query: [VarListSetOper: [VarList: ['tick', 'tock'], RelPropValue: [UnivProp: [Const: .seen]]]]",
    'Query: [LiftProp: [Const: .created]]',
    'Query: [LiftPropBy: [Const: .created, Cmpr: <, Const: 2010]]',
    'Query: [LiftPropBy: [Const: .created, Cmpr: >, Const: 2010]]',
    "Query: [LiftPropBy: [Const: .created, ByNameCmpr: (['range'], '='), List: [Const: 2010, Const: ?]]]",
    "Query: [LiftPropBy: [Const: .created, ByNameCmpr: (['range'], '='), List: [Const: 2010, Const: 3001]]]",
    'Query: [LiftPropBy: [Const: .created, Cmpr: =, Const: 2001]]',
    'Query: [LiftPropBy: [Const: .created, Cmpr: =, Const: {created}]]',
    'Query: [LiftProp: [Const: .seen], EditUnivDel: [UnivProp: [Const: .seen]]]',
    'Query: [LiftPropBy: [Const: .seen, Cmpr: ~=, Const: ^r]]',
    ...
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foo], FiltOper: [Const: +, TagCond: [TagMatch: [VarValue: [Const: tag]]]]]',
    ...
    "Query: [LiftProp: [Const: meta:source], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: node]], ByNameCmpr: (['range'], '='), List: [List: [Const: test:comp, List: [Const: 1000, Const: green]], List: [Const: test:comp, List: [Const: 3000, Const: ham]]]]]]",
    'Query: [LiftProp: [Const: meta:source]]',
    'Query: [LiftPropBy: [Const: file:bytes:size, Cmpr: =, Const: 4]]',
    ...
    "Query: [LiftProp: [Const: geo:place], FiltOper: [Const: +, AbsPropCond: [Const: geo:place:latlong, ByNameCmpr: (['near'], '='), List: [List: [Const: 34.1, Const: -118.3], Const: 10km]]]]",
    "Query: [LiftProp: [Const: geo:place], FiltOper: [Const: -, RelPropCond: [RelPropValue: [RelProp: [Const: latlong]], ByNameCmpr: (['near'], '='), List: [List: [Const: 34.1, Const: -118.3], Const: 50m]]]]",
    "Query: [LiftPropBy: [Const: geo:place:latlong, ByNameCmpr: (['near'], '='), List: [List: [Const: 34.118560, Const: -118.300370], Const: 2600m]]]",
    "Query: [LiftPropBy: [Const: geo:place:latlong, ByNameCmpr: (['near'], '='), List: [List: [Const: 34.118560, Const: -118.300370], Const: 50m]]]",
    "Query: [LiftPropBy: [Const: geo:place:latlong, ByNameCmpr: (['near'], '='), List: [List: [Const: 0, Const: 0], Const: 50m]]]",
    "Query: [LiftPropBy: [Const: geo:place:latlong, ByNameCmpr: (['near'], '='), List: [List: [Const: 34.1, Const: -118.3], Const: 10km]]]",
    "Query: [LiftPropBy: [Const: geo:place, Cmpr: =, Const: abcd], SetVarOper: [Const: latlong, RelPropValue: [RelProp: [Const: latlong]]], SetVarOper: [Const: radius, RelPropValue: [RelProp: [Const: radius]]], CmdOper: [Const: spin, Const: ()], LiftPropBy: [Const: tel:mob:telem:latlong, ByNameCmpr: (['near'], '='), List: [VarValue: [Const: latlong], Const: 3km]]]",
    'Query: [LiftPropBy: [Const: meta:note, Cmpr: =, Const: abcd], CmdOper: [Const: noderefs, List: [Const: -d, Const: 2, Const: --join]]]',
    'Query: [CmdOper: [Const: help, Const: ()]]',
    ...
    'Query: [LiftPropBy: [Const: inet:asn, Cmpr: =, Const: 10], CmdOper: [Const: noderefs, List: [Const: -of, Const: inet:ip, Const: --join, Const: -d, Const: 3]]]',
    'Query: [LiftProp: [Const: inet:dns:a], FiltOper: [Const: +, SubqCond: [Query: [PropPivot: [RelPropValue: [RelProp: [Const: ip]], PivotTarget: [Const: inet:ip]], isjoin=False, FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: loc]], Cmpr: =, Const: us]]]]]]',
    'Query: [LiftProp: [Const: inet:dns:a], FiltOper: [Const: +, SubqCond: [Query: [PropPivot: [RelPropValue: [RelProp: [Const: ip]], PivotTarget: [Const: inet:ip]], isjoin=False, FiltOper: [Const: -, RelPropCond: [RelPropValue: [RelProp: [Const: loc]], Cmpr: =, Const: us]]]]]]',
    'Query: [LiftProp: [Const: inet:dns:a], FiltOper: [Const: -, SubqCond: [Query: [PropPivot: [RelPropValue: [RelProp: [Const: ip]], PivotTarget: [Const: inet:ip]], isjoin=False, FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: loc]], Cmpr: =, Const: us]]]]]]',
    'Query: [LiftProp: [Const: inet:dns:a], FiltOper: [Const: -, SubqCond: [Query: [PropPivot: [RelPropValue: [RelProp: [Const: ip]], PivotTarget: [Const: inet:ip]], isjoin=False, FiltOper: [Const: -, RelPropCond: [RelPropValue: [RelProp: [Const: loc]], Cmpr: =, Const: us]]]]]]',
    'Query: [LiftProp: [Const: inet:dns:a], PropPivotOut: [RelPropValue: [RelProp: [Const: ip]]], isjoin=False]',
    'Query: [LiftPropBy: [Const: inet:dns:a, Cmpr: =, List: [Const: woot.com, Const: 12.34.56.78]], EditPropSet: [UnivProp: [Const: .seen], Const: =, List: [Const: 201708010123, Const: 201708100456]]]',
    'Query: [LiftPropBy: [Const: inet:dns:a, Cmpr: =, List: [Const: woot.com, Const: 12.34.56.78]], EditPropSet: [UnivProp: [Const: .seen], Const: =, List: [Const: 201708010123, Const: ?]]]',
    'Query: [LiftProp: [Const: inet:dns:a]]',
    'Query: [LiftPropBy: [Const: inet:dns:a, Cmpr: =, List: [Const: woot.com, Const: 1.2.3.4]], SetVarOper: [Const: hehe, RelPropValue: [RelProp: [Const: fqdn]]], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: fqdn]], Cmpr: =, VarValue: [Const: hehe]]]]',
    'Query: [LiftPropBy: [Const: inet:dns:a, Cmpr: =, List: [Const: woot.com, Const: 1.2.3.4]], SetVarOper: [Const: hehe, RelPropValue: [RelProp: [Const: fqdn]]], FiltOper: [Const: -, RelPropCond: [RelPropValue: [RelProp: [Const: fqdn]], Cmpr: =, VarValue: [Const: hehe]]]]',
    'Query: [LiftPropBy: [Const: inet:dns:a, Cmpr: =, List: [Const: woot.com, Const: 1.2.3.4]], SetVarOper: [Const: hehe, RelPropValue: [RelProp: [Const: fqdn]]], LiftPropBy: [Const: inet:fqdn, Cmpr: =, VarValue: [Const: hehe]]]',
    'Query: [LiftPropBy: [Const: inet:dns:a, Cmpr: =, List: [Const: woot.com, Const: 1.2.3.4]], SetVarOper: [Const: newp, RelPropValue: [UnivProp: [Const: .seen]]]]',
    'Query: [LiftPropBy: [Const: inet:dns:a, Cmpr: =, List: [Const: woot.com, Const: 1.2.3.4]], SetVarOper: [Const: seen, RelPropValue: [UnivProp: [Const: .seen]]], PropPivot: [RelPropValue: [RelProp: [Const: fqdn]], PivotTarget: [Const: inet:fqdn]], isjoin=False, EditPropSet: [UnivProp: [Const: .seen], Const: =, VarValue: [Const: seen]]]',
    'Query: [LiftPropBy: [Const: inet:dns:a, Cmpr: =, List: [Const: woot.com, Const: 1.2.3.4]], EditPropSet: [UnivProp: [Const: .seen], Const: =, List: [Const: 2015, Const: 2018]]]',
    'Query: [LiftPropBy: [Const: inet:dns:query, Cmpr: =, List: [Const: tcp://1.2.3.4, Const: , Const: 1]], PropPivot: [RelPropValue: [RelProp: [Const: name]], PivotTarget: [Const: inet:fqdn]], isjoin=False]',
    'Query: [LiftPropBy: [Const: inet:dns:query, Cmpr: =, List: [Const: tcp://1.2.3.4, Const: foo*.haha.com, Const: 1]], PropPivot: [RelPropValue: [RelProp: [Const: name]], PivotTarget: [Const: inet:fqdn]], isjoin=False]',
    'Query: [LiftProp: [Const: inet:fqdn], FiltOper: [Const: +, TagCond: [TagMatch: [Const: bad]]], SetVarOper: [Const: fqdnbad, TagValue: [TagName: [Const: bad]]], FormPivot: [PivotTarget: [Const: inet:dns:a:fqdn]], isjoin=False, FiltOper: [Const: +, RelPropCond: [RelPropValue: [UnivProp: [Const: .seen]], Cmpr: @=, VarValue: [Const: fqdnbad]]]]',
    'Query: [LiftPropBy: [Const: inet:fqdn, Cmpr: =, Const: woot.com], FormPivot: [PivotTarget: [Const: inet:dns:a]], isjoin=False, FormPivot: [PivotTarget: [Const: inet:ip]], isjoin=False]',
    'Query: [LiftPropBy: [Const: inet:fqdn, Cmpr: =, Const: woot.com], FormPivot: [PivotTarget: [Const: inet:dns:a]], isjoin=False]',
    'Query: [LiftPropBy: [Const: inet:fqdn, Cmpr: =, Const: woot.com], CmdOper: [Const: delnode, Const: ()]]',
    ...
    'Query: [LiftPropBy: [Const: inet:fqdn, Cmpr: =, Const: woot.com]]',
    'Query: [LiftProp: [Const: inet:ip], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: asn::name]], Cmpr: =, Const: visi]]]',
    'Query: [LiftProp: [Const: inet:ip], FiltOper: [Const: +, AbsPropCond: [Const: inet:ip, Cmpr: =, Const: 1.2.3.0/30]]]',
    'Query: [LiftProp: [Const: inet:ip], FiltOper: [Const: +, AbsPropCond: [Const: inet:ip, Cmpr: =, Const: 1.2.3.1-1.2.3.3]]]',
    'Query: [LiftProp: [Const: inet:ip], FiltOper: [Const: +, AbsPropCond: [Const: inet:ip, Cmpr: =, Const: 10.2.1.4/32]]]',
    ...
    'Query: [LiftPropBy: [Const: inet:ip:loc, Cmpr: =, Const: us]]',
    'Query: [LiftPropBy: [Const: inet:ip:loc, Cmpr: =, Const: zz]]',
    'Query: [LiftPropBy: [Const: inet:ip, Cmpr: =, Const: 1.2.3.1-1.2.3.3]]',
    'Query: [LiftPropBy: [Const: inet:ip, Cmpr: =, Const: 192.168.1.0/24]]',
    'Query: [LiftPropBy: [Const: inet:ip, Cmpr: =, Const: 1.2.3.4], FiltOper: [Const: +, HasRelPropCond: [RelProp: [Const: asn]]]]',
    'Query: [LiftPropBy: [Const: inet:ip, Cmpr: =, Const: 1.2.3.4], FiltOper: [Const: +, SubqCond: [Query: [FormPivot: [PivotTarget: [Const: inet:dns:a]], isjoin=False], Cmpr: <, Const: 2]]]',
    'Query: [LiftPropBy: [Const: inet:ip, Cmpr: =, Const: 1.2.3.4], FiltOper: [Const: +, SubqCond: [Query: [FormPivot: [PivotTarget: [Const: inet:dns:a]], isjoin=False], Cmpr: <=, Const: 1]]]',
    'Query: [LiftPropBy: [Const: inet:ip, Cmpr: =, Const: 1.2.3.4], FiltOper: [Const: +, SubqCond: [Query: [FormPivot: [PivotTarget: [Const: inet:dns:a]], isjoin=False], Cmpr: !=, Const: 2]]]',
    'Query: [LiftPropBy: [Const: inet:ip, Cmpr: =, Const: 1.2.3.4], CmdOper: [Const: limit, List: [Const: 20]]]',
    'Query: [LiftPropBy: [Const: inet:ip, Cmpr: =, Const: 12.34.56.78], EditPropSet: [RelProp: [Const: loc], Const: =, Const: us.oh.wilmington]]',
    'Query: [LiftPropBy: [Const: inet:ip, Cmpr: =, Const: 12.34.56.78], LiftPropBy: [Const: inet:fqdn, Cmpr: =, Const: woot.com], EditNodeAdd: [FormName: [Const: inet:ip], Const: =, Const: 1.2.3.4], EditPropSet: [RelProp: [Const: asn], Const: =, Const: 10101], EditNodeAdd: [FormName: [Const: inet:fqdn], Const: =, Const: woowoo.com], EditTagAdd: [TagName: [Const: my, Const: tag]]]',
    ...
    'Query: [LiftProp: [Const: inet:user], CmdOper: [Const: limit, List: [Const: 10]], FiltOper: [Const: +, AbsPropCond: [Const: inet:user, Cmpr: =, Const: visi]]]',
    'Query: [LiftProp: [Const: inet:user], CmdOper: [Const: limit, List: [Const: 10]], EditTagAdd: [TagName: [Const: foo, Const: bar]]]',
    'Query: [LiftPropBy: [Const: media:news, Cmpr: =, Const: 00a1f0d928e25729b9e86e2d08c127ce], EditPropSet: [RelProp: [Const: summary], Const: =, Const: ]]',
    'Query: [LiftPropBy: [Const: meta:source:meta:source, Cmpr: =, VarValue: [Const: sorc]], PivotOut: [], isjoin=False]',
    'Query: [LiftPropBy: [Const: meta:source:meta:source, Cmpr: =, VarValue: [Const: sorc]], PropPivotOut: [RelPropValue: [RelProp: [Const: node]]], isjoin=False]',
    'Query: [LiftPropBy: [Const: meta:source, Cmpr: =, Const: 8f1401de15918358d5247e21ca29a814]]',
    'Query: [CmdOper: [Const: movetag, List: [Const: a.b, Const: a.m]]]',
    'Query: [CmdOper: [Const: movetag, List: [Const: hehe, Const: woot]]]',
    'Query: [LiftPropBy: [Const: ps:person, Cmpr: =, VarValue: [Const: pers]], FormPivot: [PivotTarget: [Const: meta:source]], isjoin=False, PivotOut: [], isjoin=False]',
    'Query: [LiftPropBy: [Const: ps:person, Cmpr: =, VarValue: [Const: pers]], FormPivot: [PivotTarget: [Const: meta:source]], isjoin=False, FormPivot: [PivotTarget: [Const: geo:place]], isjoin=False]',
    'Query: [LiftPropBy: [Const: ps:person, Cmpr: =, VarValue: [Const: pers]], FormPivot: [PivotTarget: [Const: meta:source]], isjoin=False, FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: time]], Cmpr: @=, List: [Const: 2014, Const: 2017]]], FormPivot: [PivotTarget: [Const: geo:place]], isjoin=False]',
    'Query: [LiftPropBy: [Const: ps:person, Cmpr: =, VarValue: [Const: pers]], FormPivot: [PivotTarget: [Const: meta:source]], isjoin=False, PivotOut: [], isjoin=False]',
    'Query: [LiftPropBy: [Const: ps:person, Cmpr: =, VarValue: [Const: pers]], FormPivot: [PivotTarget: [Const: meta:source]], isjoin=False, PropPivotOut: [RelPropValue: [RelProp: [Const: node]]], isjoin=False]',
    ...
    'Query: [CmdOper: [Const: sudo, Const: ()], LiftPropBy: [Const: test:int, Cmpr: =, Const: 6], CmdOper: [Const: delnode, Const: ()]]',
    'Query: [LiftPropBy: [Const: syn:tag, Cmpr: =, Const: a.b], FiltOper: [Const: +, TagCond: [TagMatch: [Const: foo]]]]',
    'Query: [LiftPropBy: [Const: syn:tag, Cmpr: =, Const: aaa.barbarella.ddd]]',
    'Query: [LiftPropBy: [Const: syn:tag, Cmpr: =, Const: baz.faz], EditTagAdd: [TagName: [Const: foo, Const: bar]]]',
    'Query: [LiftPropBy: [Const: syn:tag, Cmpr: =, Const: foo.bar], PivotOut: [], isjoin=False]',
    'Query: [LiftPropBy: [Const: syn:tag, Cmpr: =, Const: foo.bar], FormPivot: [PivotTarget: [Const: test:str]], isjoin=False]',
    'Query: [LiftPropBy: [Const: syn:tag, Cmpr: =, Const: foo.bar], FormPivot: [PivotTarget: [Const: test:str:tick]], isjoin=False]',
    'Query: [LiftProp: [Const: test:comp], FiltOper: [Const: +, AndCond: [RelPropCond: [RelPropValue: [RelProp: [Const: hehe]], Cmpr: <, Const: 2], RelPropCond: [RelPropValue: [RelProp: [Const: haha]], Cmpr: =, Const: test]]]]',
    'Query: [LiftProp: [Const: test:comp], FiltOper: [Const: +, OrCond: [RelPropCond: [RelPropValue: [RelProp: [Const: hehe]], Cmpr: <, Const: 2], TagCond: [TagMatch: [Const: meep, Const: gorp]]]]]',
    'Query: [LiftProp: [Const: test:comp], FiltOper: [Const: +, OrCond: [RelPropCond: [RelPropValue: [RelProp: [Const: hehe]], Cmpr: <, Const: 2], RelPropCond: [RelPropValue: [RelProp: [Const: haha]], Cmpr: =, Const: test]]]]',
    "Query: [LiftProp: [Const: test:comp], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: haha]], ByNameCmpr: (['range'], '='), List: [Const: grinch, Const: meanone]]]]",
    "Query: [LiftProp: [Const: test:comp], FiltOper: [Const: +, AbsPropCond: [Const: test:comp, ByNameCmpr: (['range'], '='), List: [List: [Const: 1024, Const: grinch], List: [Const: 4096, Const: zemeanone]]]]]",
    ...
    'Query: [LiftPropBy: [Const: test:comp:haha, Cmpr: ~=, Const: ^lulz]]',
    'Query: [LiftPropBy: [Const: test:comp:haha, Cmpr: ~=, Const: ^zerg]]',
    'Query: [LiftFormTag: [Const: test:comp, TagName: [Const: bar]], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: hehe]], Cmpr: =, Const: 1010]], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: haha]], Cmpr: =, Const: test10]], FiltOper: [Const: +, TagCond: [TagMatch: [Const: bar]]]]',
    "Query: [LiftProp: [Const: test:guid], FiltOper: [Const: +, AbsPropCond: [Const: test:guid, ByNameCmpr: (['range'], '='), List: [Const: abcd, Const: dcbe]]]]",
    ...
    'Query: [LiftProp: [Const: test:int], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: loc]], Cmpr: =, Const: ]]]',
    'Query: [LiftProp: [Const: test:int], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: loc]], Cmpr: =, Const: us.va. syria]]]',
    'Query: [LiftProp: [Const: test:int], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: loc]], Cmpr: =, Const: u]]]',
    'Query: [LiftProp: [Const: test:int], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: loc]], Cmpr: =, Const: us]]]',
    'Query: [LiftProp: [Const: test:int], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: loc]], Cmpr: =, Const: us.v]]]',
    'Query: [LiftProp: [Const: test:int], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: loc]], Cmpr: =, Const: us.va.sydney]]]',
    'Query: [LiftProp: [Const: test:int], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: loc]], Cmpr: ^=, Const: ]]]',
    'Query: [LiftProp: [Const: test:int], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: loc]], Cmpr: ^=, Const: 23]]]',
    'Query: [LiftProp: [Const: test:int], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: loc]], Cmpr: ^=, Const: u]]]',
    'Query: [LiftProp: [Const: test:int], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: loc]], Cmpr: ^=, Const: us]]]',
    'Query: [LiftProp: [Const: test:int], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: loc]], Cmpr: ^=, Const: us.]]]',
    'Query: [LiftProp: [Const: test:int], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: loc]], Cmpr: ^=, Const: us.va.]]]',
    'Query: [LiftProp: [Const: test:int], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: loc]], Cmpr: ^=, Const: us.va.fairfax.reston]]]',
    'Query: [LiftProp: [Const: test:int], FiltOper: [Const: +, AbsPropCond: [Const: test:int, Cmpr: <, Const: 30]]]',
    'Query: [LiftProp: [Const: test:int], FiltOper: [Const: +, AbsPropCond: [Const: test:int, Cmpr: <=, Const: 30]]]',
    'Query: [LiftPropBy: [Const: test:int, Cmpr: <=, Const: 20]]',
    "Query: [LiftProp: [Const: test:int], CmdOper: [Const: noderefs, Const: ()], FiltOper: [Const: +, AbsPropCond: [Const: test:comp, ByNameCmpr: (['range'], '='), List: [List: [Const: 1000, Const: grinch], List: [Const: 4000, Const: whoville]]]]]",
    'Query: [LiftPropBy: [Const: test:int:loc, Cmpr: =, Const: ]]',
    'Query: [LiftPropBy: [Const: test:int:loc, Cmpr: =, Const: u]]',
    'Query: [LiftPropBy: [Const: test:int:loc, Cmpr: =, Const: us]]',
    'Query: [LiftPropBy: [Const: test:int:loc, Cmpr: ^=, Const: ]]',
    'Query: [LiftPropBy: [Const: test:int:loc, Cmpr: ^=, Const: 23]]',
    'Query: [LiftPropBy: [Const: test:int:loc, Cmpr: ^=, Const: u]]',
    'Query: [LiftPropBy: [Const: test:int:loc, Cmpr: ^=, Const: us]]',
    'Query: [LiftPropBy: [Const: test:int:loc, Cmpr: ^=, Const: us.]]',
    'Query: [LiftPropBy: [Const: test:int:loc, Cmpr: ^=, Const: us.va.fairfax.reston]]',
    'Query: [LiftPropBy: [Const: test:int, Cmpr: <, Const: 30]]',
    'Query: [LiftPropBy: [Const: test:int, Cmpr: <=, Const: 30]]',
    'Query: [LiftPropBy: [Const: test:int, Cmpr: =, Const: 123], CmdOper: [Const: noderefs, List: [Const: -te]]]',
    'Query: [LiftPropBy: [Const: test:int, Cmpr: =, Const: 123], CmdOper: [Const: noderefs, Const: ()]]',
    'Query: [LiftPropBy: [Const: test:int, Cmpr: =, Const: 1234], EditNodeAdd: [FormName: [Const: test:str], Const: =, FuncCall: [VarDeref: [VarValue: [Const: node], Const: form], CallArgs: [], CallKwargs: []]], FiltOper: [Const: -, HasAbsPropCond: [Const: test:int]]]',
    'Query: [LiftPropBy: [Const: test:int, Cmpr: =, Const: 1234], EditNodeAdd: [FormName: [Const: test:str], Const: =, FuncCall: [VarDeref: [VarValue: [Const: node], Const: value], CallArgs: [], CallKwargs: []]], FiltOper: [Const: -, HasAbsPropCond: [Const: test:int]]]',
    'Query: [LiftPropBy: [Const: test:int, Cmpr: =, Const: 3735928559]]',
    'Query: [LiftPropBy: [Const: test:int, Cmpr: =, Const: 8675309]]',
    'Query: [LiftPropBy: [Const: test:int, Cmpr: >, Const: 30]]',
    'Query: [LiftPropBy: [Const: test:int, Cmpr: >=, Const: 20]]',
    ...
    'Query: [LiftPropBy: [Const: test:pivcomp:tick, Cmpr: =, VarValue: [Const: foo]]]',
    'Query: [LiftPropBy: [Const: test:pivcomp, Cmpr: =, VarValue: [Const: foo]]]',
    'Query: [LiftPropBy: [Const: test:pivcomp, Cmpr: =, List: [Const: foo, Const: bar]], FiltOper: [Const: +, SubqCond: [Query: [PropPivot: [RelPropValue: [RelProp: [Const: lulz]], PivotTarget: [Const: test:str]], isjoin=False, FiltOper: [Const: +, TagCond: [TagMatch: [Const: baz]]]]]], FiltOper: [Const: +, HasAbsPropCond: [Const: test:pivcomp]]]',
    'Query: [LiftPropBy: [Const: test:pivcomp, Cmpr: =, List: [Const: foo, Const: bar]], PivotOut: [], isjoin=True]',
    'Query: [LiftPropBy: [Const: test:pivcomp, Cmpr: =, List: [Const: foo, Const: bar]], FormPivot: [PivotTarget: [Const: test:pivtarg]], isjoin=True]',
    'Query: [LiftPropBy: [Const: test:pivcomp, Cmpr: =, List: [Const: foo, Const: bar]], PivotOut: [], isjoin=False]',
    'Query: [LiftPropBy: [Const: test:pivcomp, Cmpr: =, List: [Const: foo, Const: bar]], FormPivot: [PivotTarget: [Const: test:pivtarg]], isjoin=False]',
    'Query: [LiftPropBy: [Const: test:pivcomp, Cmpr: =, List: [Const: foo, Const: bar]], FiltOper: [Const: -, SubqCond: [Query: [PropPivot: [RelPropValue: [RelProp: [Const: lulz]], PivotTarget: [Const: test:str]], isjoin=False, FiltOper: [Const: +, TagCond: [TagMatch: [Const: baz]]]]]]]',
    'Query: [LiftPropBy: [Const: test:pivcomp, Cmpr: =, List: [Const: foo, Const: bar]], PropPivot: [RelPropValue: [RelProp: [Const: lulz]], PivotTarget: [Const: test:str]], isjoin=True]',
    'Query: [LiftPropBy: [Const: test:pivcomp, Cmpr: =, List: [Const: foo, Const: bar]], PropPivot: [RelPropValue: [RelProp: [Const: lulz]], PivotTarget: [Const: test:str]], isjoin=False]',
    'Query: [LiftPropBy: [Const: test:pivcomp, Cmpr: =, List: [Const: foo, Const: bar]], PropPivot: [RelPropValue: [RelProp: [Const: targ]], PivotTarget: [Const: test:pivtarg]], isjoin=False]',
    'Query: [LiftPropBy: [Const: test:pivcomp, Cmpr: =, List: [Const: hehe, Const: haha]], SetVarOper: [Const: ticktock, TagValue: [TagName: [Const: foo]]], FormPivot: [PivotTarget: [Const: test:pivtarg]], isjoin=False, FiltOper: [Const: +, RelPropCond: [RelPropValue: [UnivProp: [Const: .seen]], Cmpr: @=, VarValue: [Const: ticktock]]]]',
    'Query: [LiftPropBy: [Const: test:pivcomp, Cmpr: =, List: [Const: hehe, Const: haha]]]',
    'Query: [LiftPropBy: [Const: test:pivtarg, Cmpr: =, Const: hehe], EditPropSet: [UnivProp: [Const: .seen], Const: =, Const: 2015]]',
    ...
    'Query: [LiftProp: [Const: test:str], FiltOper: [Const: +, TagCond: [TagMatch: [Const: foo, Const: *, Const: baz]]]]',
    'Query: [LiftTag: [TagName: [Const: foo], Cmpr: @=, List: [Const: 2013, Const: 2015]]]',
    'Query: [LiftProp: [Const: test:str], FiltOper: [Const: +, TagValuCond: [TagMatch: [Const: foo], Cmpr: @=, List: [Const: 2014, Const: 20141231]]]]',
    'Query: [LiftProp: [Const: test:str], FiltOper: [Const: +, TagValuCond: [TagMatch: [Const: foo], Cmpr: @=, List: [Const: 2015, Const: 2018]]]]',
    'Query: [LiftProp: [Const: test:str], FiltOper: [Const: +, TagValuCond: [TagMatch: [Const: foo], Cmpr: @=, Const: 2016]]]',
    "Query: [LiftProp: [Const: test:str], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: bar]], ByNameCmpr: (['range'], '='), List: [List: [Const: test:str, Const: c], List: [Const: test:str, Const: q]]]]]",
    "Query: [LiftProp: [Const: test:str], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: tick]], ByNameCmpr: (['range'], '='), List: [Const: 19701125, Const: 20151212]]]]",
    'Query: [LiftProp: [Const: test:str], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: tick]], Cmpr: =, List: [VarValue: [Const: test], Const: +- 2day]]]]',
    'Query: [LiftProp: [Const: test:str], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: tick]], Cmpr: =, List: [Const: 2015, Const: +1 day]]]]',
    'Query: [LiftProp: [Const: test:str], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: tick]], Cmpr: =, List: [Const: 20150102, Const: -3 day]]]]',
    'Query: [LiftProp: [Const: test:str], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: tick]], Cmpr: =, List: [Const: 20150201, Const: +1 day]]]]',
    'Query: [LiftProp: [Const: test:str], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: tick]], Cmpr: =, Const: 2015]]]',
    'Query: [LiftProp: [Const: test:str], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: tick]], Cmpr: @=, Const: -1 day]]]',
    'Query: [LiftProp: [Const: test:str], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: tick]], Cmpr: @=, List: [Const: now+2days, Const: -3 day]]]]',
    'Query: [LiftProp: [Const: test:str], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: tick]], Cmpr: @=, List: [Const: now-1day, Const: ?]]]]',
    'Query: [LiftProp: [Const: test:str], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: tick]], Cmpr: @=, Const: 2015]]]',
    'Query: [LiftProp: [Const: test:str], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: tick]], Cmpr: @=, List: [Const: 2015, Const: +1 day]]]]',
    'Query: [LiftProp: [Const: test:str], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: tick]], Cmpr: @=, List: [Const: 20150102+1day, Const: -4 day]]]]',
    'Query: [LiftProp: [Const: test:str], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: tick]], Cmpr: @=, List: [Const: 20150102, Const: -4 day]]]]',
    'Query: [LiftProp: [Const: test:str], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: tick]], Cmpr: @=, List: [Const: now, Const: -1 day]]]]',
    'Query: [LiftProp: [Const: test:str], FiltOper: [Const: +, AbsPropCond: [Const: test:str:tick, Cmpr: <, Const: 201808021202]]]',
    'Query: [LiftProp: [Const: test:str], FiltOper: [Const: +, AbsPropCond: [Const: test:str:tick, Cmpr: <=, Const: 201808021202]]]',
    'Query: [LiftProp: [Const: test:str], FiltOper: [Const: +, AbsPropCond: [Const: test:str:tick, Cmpr: >, Const: 201808021202]]]',
    'Query: [LiftProp: [Const: test:str], FiltOper: [Const: +, AbsPropCond: [Const: test:str:tick, Cmpr: >=, Const: 201808021202]]]',
    'Query: [LiftProp: [Const: test:str], FiltOper: [Const: -, TagCond: [TagMatch: [Const: *]]]]',
    ...
    'Query: [LiftFormTag: [Const: test:str, TagName: [Const: foo], Cmpr: @=, List: [Const: 2012, Const: 2022]]]',
    'Query: [LiftFormTag: [Const: test:str, TagName: [Const: foo], Cmpr: @=, Const: 2016]]',
    'Query: [LiftProp: [Const: test:str]]',
    'Query: [LiftPropBy: [Const: test:str:tick, Cmpr: <, Const: 201808021202]]',
    'Query: [LiftPropBy: [Const: test:str:tick, Cmpr: <=, Const: 201808021202]]',
    'Query: [LiftPropBy: [Const: test:str:tick, Cmpr: =, List: [Const: 20131231, Const: +2 days]]]',
    'Query: [LiftPropBy: [Const: test:str:tick, Cmpr: =, Const: 2015]]',
    'Query: [LiftPropBy: [Const: test:str:tick, Cmpr: >, Const: 201808021202]]',
    'Query: [LiftPropBy: [Const: test:str:tick, Cmpr: >=, Const: 201808021202]]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foo]]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foo bar], FiltOper: [Const: +, HasAbsPropCond: [Const: test:str]]]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foo bar], FiltOper: [Const: -, HasAbsPropCond: [Const: test:str:tick]]]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foo bar], EditPropDel: [RelProp: [Const: tick]]]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, VarValue: [Const: foo]]]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: 123], EditPropSet: [RelProp: [Const: baz], Const: =, Const: test:guid:tick=2015]]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: 123], CmdOper: [Const: noderefs, List: [Const: --traverse-edge]]]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: 123], CmdOper: [Const: noderefs, Const: ()]]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: 1234], LiftPropBy: [Const: test:str, Cmpr: =, Const: duck], LiftPropBy: [Const: test:str, Cmpr: =, Const: knight]]',
    "Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: a], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: tick]], ByNameCmpr: (['range'], '='), List: [Const: 20000101, Const: 20101201]]]]",
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: bar], FormPivot: [PivotTarget: [Const: test:pivcomp:lulz]], isjoin=True]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: bar], FormPivot: [PivotTarget: [Const: test:pivcomp:lulz]], isjoin=False]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: bar], PivotIn: [], isjoin=True]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: bar], PivotIn: [], isjoin=False]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: bar], LiftPropBy: [Const: test:pivcomp, Cmpr: =, List: [Const: foo, Const: bar]], EditTagAdd: [TagName: [Const: test, Const: bar]]]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foo], FiltOper: [Const: +, TagValuCond: [TagMatch: [Const: lol], Cmpr: @=, Const: 2016]]]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foo], CmdOper: [Const: delnode, Const: ()]]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foobar], FormPivot: [PivotTarget: [Const: meta:source]], isjoin=True]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foobar], FormPivot: [PivotTarget: [Const: meta:source]], isjoin=False, PivotIn: [], isjoin=True]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foobar], FormPivot: [PivotTarget: [Const: meta:source]], isjoin=False, PivotIn: [], isjoin=False]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: hello], EditPropSet: [RelProp: [Const: tick], Const: =, Const: 2001]]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: hello], EditPropSet: [RelProp: [Const: tick], Const: =, Const: 2002]]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: pennywise], CmdOper: [Const: noderefs, List: [Const: --join, Const: -d, Const: 9, Const: --traverse-edge]]]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: pennywise], CmdOper: [Const: noderefs, List: [Const: -d, Const: 3, Const: --omit-traversal-tag, Const: omit.nopiv, Const: --omit-traversal-tag, Const: test]]]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: visi], PivotToTags: [TagMatch: [Const: *]], isjoin=False]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: visi], PivotToTags: [TagMatch: [Const: foo, Const: *]], isjoin=False]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: woot], SetVarOper: [Const: foo, TagValue: [TagName: [Const: foo]]], FiltOper: [Const: +, RelPropCond: [RelPropValue: [UnivProp: [Const: .seen]], Cmpr: @=, VarValue: [Const: foo]]]]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: woot], FiltOper: [Const: +, RelPropCond: [RelPropValue: [UnivProp: [Const: .seen]], Cmpr: @=, TagValue: [TagName: [Const: bar]]]]]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: woot], FiltOper: [Const: +, RelPropCond: [RelPropValue: [UnivProp: [Const: .seen]], Cmpr: @=, List: [Const: 2012, Const: 2015]]]]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: woot], FiltOper: [Const: +, RelPropCond: [RelPropValue: [UnivProp: [Const: .seen]], Cmpr: @=, Const: 2012]]]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: ~=, Const: zip]]',
    ...
    'Query: [LiftPropBy: [Const: inet:ip, Cmpr: =, Const: 1], SetVarOper: [Const: foo, RelPropValue: [UnivProp: [Const: .created]]], SetVarOper: [Const: bar, DollarExpr: [ExprNode: [VarValue: [Const: foo], Const: +, Const: 1]]]]',
    ...
    'Query: [SetVarOper: [Const: foo, Const: 1], SetVarOper: [Const: bar, Const: 2], LiftPropBy: [Const: inet:ip, Cmpr: =, DollarExpr: [ExprNode: [VarValue: [Const: foo], Const: +, VarValue: [Const: bar]]]]]',
    'Query: []',
    ...
    'Query: [LiftTagProp: [TagProp: [TagName: [Const: baz, Const: faz], Const: lol], Cmpr: =, Const: 20]]',
    'Query: [LiftFormTagProp: [FormTagProp: [Const: foo:bar, TagName: [Const: baz, Const: faz], Const: lol], Cmpr: =, Const: 20]]',
    'Query: [FiltOper: [Const: +, HasTagPropCond: [TagMatch: [Const: foo, Const: bar], Const: lol]]]',
    'Query: [FiltOper: [Const: +, TagPropCond: [TagMatch: [Const: foo, Const: bar], Const: lol, Cmpr: =, Const: 20]]]',
    ...
    "Query: [LiftTagProp: [TagProp: [TagName: [Const: tag], Const: somegeoloctypebecauseihatelife], ByNameCmpr: (['near'], '='), List: [VarValue: [Const: lat], VarValue: [Const: long]]]]",
    "Query: [LiftPropBy: [VarValue: [Const: foo], ByNameCmpr: (['near'], '='), Const: 20]]",
    ...
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, VarDeref: [VarDeref: [VarValue: [Const: foo], VarValue: [Const: space key]], Const: subkey]]]',
    'Query: [ForLoop: [Const: iterkey, VarDeref: [VarDeref: [VarValue: [Const: foo], VarValue: [Const: bar key]], VarValue: [Const: biz key]], SubQuery: [Query: [LiftPropBy: [Const: inet:ip, Cmpr: =, VarDeref: [VarDeref: [VarDeref: [VarValue: [Const: foo], VarValue: [Const: bar key]], VarValue: [Const: biz key]], VarValue: [Const: iterkey]]]]]]]',
    ...
    'Query: [LiftPropBy: [Const: syn:tag:base, Cmpr: =, Const: foo], PivotToTags: [TagMatch: []], isjoin=True]',
    'Query: [LiftPropBy: [Const: syn:tag:depth, Cmpr: =, Const: 2], PivotToTags: [TagMatch: []], isjoin=True]',
    ...
    'Query: [LiftPropBy: [Const: inet:ip, Cmpr: =, Const: 1.2.3.4], PivotToTags: [TagMatch: []], isjoin=True]',
    'Query: [LiftPropBy: [Const: inet:ip, Cmpr: =, Const: 1.2.3.4], PivotToTags: [TagMatch: [Const: *]], isjoin=True]',
    'Query: [LiftPropBy: [Const: inet:ip, Cmpr: =, Const: 1.2.3.4], PivotToTags: [TagMatch: [Const: biz, Const: *]], isjoin=True]',
    'Query: [LiftPropBy: [Const: inet:ip, Cmpr: =, Const: 1.2.3.4], PivotToTags: [TagMatch: [Const: bar, Const: baz]], isjoin=True]',
    ...
    "Query: [LiftProp: [Const: test:arrayprop], FiltOper: [Const: +, ArrayCond: [RelProp: [Const: ints], ByNameCmpr: (['range'], '='), List: [Const: 50, Const: 100]]]]",
    ...
    'Query: [LiftPropBy: [Const: inet:ip, Cmpr: =, Const: 1.2.3.4], FiltOper: [Const: +, DollarExpr: [ExprNode: [ExprNode: [RelPropValue: [RelProp: [Const: asn]], Const: +, Const: 20], Const: >=, Const: 42]]]]',
    'Query: [LiftProp: [Const: inet:ip], N1Walk: [Const: seen, Const: foo:bar:baz], isjoin=False]',
    'Query: [LiftProp: [Const: inet:ip], N1Walk: [Const: seen, List: [Const: foo:bar:baz, Const: hehe:haha:hoho], Cmpr: ^=, Const: lol], isjoin=False]',
    "Query: [LiftProp: [Const: inet:ip], N1Walk: [VarList: ['foo', 'bar'], List: [VarValue: [Const: baz], VarValue: [Const: faz]], Cmpr: =, Const: lol], isjoin=False]",
    ...
    'Query: [LiftPropBy: [Const: inet:ip, Cmpr: =, Const: 1.2.3.4]]',
    'Query: [LiftPropBy: [VarValue: [Const: form], Cmpr: =, VarValue: [Const: valu]]]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foobar], FormPivot: [PivotTarget: [Const: inet:dns*]], isjoin=False]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foobar], FormPivot: [PivotTarget: [Const: inet:dns:*]], isjoin=False]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foobar], FormPivot: [List: [PivotTarget: [Const: meta:source], PivotTarget: [Const: inet:dns:a]]], isjoin=False]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foobar], FormPivot: [List: [PivotTarget: [Const: meta:source], PivotTarget: [Const: inet:dns*]]], isjoin=False]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foobar], FormPivot: [PivotTarget: [VarValue: [Const: foo]]], isjoin=False]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foobar], FormPivot: [PivotTarget: [Const: inet:dns*]], isjoin=True]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foobar], FormPivot: [PivotTarget: [Const: inet:dns:*]], isjoin=True]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foobar], FormPivot: [List: [PivotTarget: [Const: meta:source], PivotTarget: [Const: inet:dns:a]]], isjoin=True]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foobar], FormPivot: [List: [PivotTarget: [Const: meta:source], PivotTarget: [Const: inet:dns*]]], isjoin=True]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foobar], FormPivot: [PivotTarget: [VarValue: [Const: foo]]], isjoin=True]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foobar], N1Walk: [Const: refs, Const: inet:dns:*], isjoin=False]',
    'Query: [LiftPropBy: [Const: inet:fqdn, Cmpr: =, Const: foo.com], PropPivot: [RelPropValue: [RelProp: [Const: zone]], List: [PivotTarget: [Const: meta:source], PivotTarget: [Const: inet:dns:a]]], isjoin=False]',
    'Query: [LiftPropBy: [Const: inet:fqdn, Cmpr: =, Const: foo.com], PropPivot: [RelPropValue: [RelProp: [Const: zone]], PivotTarget: [VarValue: [Const: foo]]], isjoin=False]',
    'Query: [LiftPropBy: [Const: inet:fqdn, Cmpr: =, Const: foo.com], PropPivot: [RelPropValue: [RelProp: [Const: zone]], List: [PivotTarget: [Const: meta:source], PivotTarget: [Const: inet:dns:a]]], isjoin=True]',
    'Query: [LiftPropBy: [Const: inet:fqdn, Cmpr: =, Const: foo.com], PropPivot: [RelPropValue: [RelProp: [Const: zone]], PivotTarget: [VarValue: [Const: foo]]], isjoin=True]',
    'Query: [LiftFormTag: [Const: test:*, TagName: [Const: foo]]]',
    'Query: [LiftFormTag: [Const: test:*, TagName: [Const: foo], Cmpr: @=, Const: 2016]]',
    'Query: [LiftFormTagProp: [FormTagProp: [Const: test:*, TagName: [Const: foo], Const: lol]]]',
    'Query: [LiftFormTagProp: [FormTagProp: [Const: test:*, TagName: [Const: foo], Const: lol], Cmpr: =, Const: 20]]',
    ...
    "Query: [LiftProp: [Const: file:bytes], N1Walk: [VarList: ['foobar', 'bizbaz'], List: [VarValue: [Const: biz], VarValue: [Const: boz]], Cmpr: =, Const: lol], isjoin=True]",
    'Query: [LiftProp: [Const: media:news], N2Walk: [List: [Const: neato, Const: burrito], Const: inet:fqdn], isjoin=True]',
    'Query: [LiftProp: [Const: inet:ip], N2Walk: [Const: *, Const: media:news], isjoin=True]',
    ...
    'Query: [EditTagVirtSet: [TagName: [Const: foo], CondSetOper: [Const: min], Const: 2020]]',
    'Query: [EditTagVirtSet: [TagName: [VarValue: [Const: foo]], CondSetOper: [Const: min], Const: 2020]]',
    'Query: [EditTagVirtSet: [TagName: [Const: foo], CondSetOper: [VarValue: [Const: var]], Const: 2020]]',
    'Query: [EditTagVirtSet: [TagName: [VarValue: [Const: foo]], CondSetOper: [VarValue: [Const: var]], Const: 2020]]',
    'Query: [EditTagVirtSet: [Const: ?, TagName: [Const: foo], CondSetOper: [Const: min], Const: 2020]]',
    'Query: [EditTagVirtSet: [Const: ?, TagName: [VarValue: [Const: foo]], CondSetOper: [Const: min], Const: 2020]]',
    'Query: [EditTagVirtSet: [Const: ?, TagName: [Const: foo], CondSetOper: [VarValue: [Const: var]], Const: 2020]]',
    'Query: [EditTagVirtSet: [Const: ?, TagName: [VarValue: [Const: foo]], CondSetOper: [VarValue: [Const: var]], Const: 2020]]',
...
'Query: [EditNodeAdd: [FormName: [Const: test:int], Const: =, Const: 1], EditTagAdd: [TagName: [FormatString: [Const: foo]]]]',
    'Query: [LiftPropBy: [Const: test:int, Cmpr: =, Const: 1], FiltOper: [Const: +, TagCond: [TagMatch: [FormatString: [Const: foo]]]]]',
    'Query: [LiftPropBy: [Const: test:int, Cmpr: =, Const: 1], Return: [DollarExpr: [TagValue: [TagName: [FormatString: [Const: foo]]]]]]',
    'Query: [EditNodeAdd: [FormName: [Const: test:int], Const: =, Const: 2], EditTagAdd: [TagName: [FormatString: [Const: foo], Const: bar]]]',
    'Query: [LiftPropBy: [Const: test:int, Cmpr: =, Const: 2], FiltOper: [Const: +, TagCond: [TagMatch: [FormatString: [Const: foo], Const: bar]]]]',
    'Query: [LiftPropBy: [Const: test:int, Cmpr: =, Const: 2], Return: [DollarExpr: [TagValue: [TagName: [FormatString: [Const: foo], Const: bar]]]]]',
    'Query: [EditNodeAdd: [FormName: [Const: test:int], Const: =, Const: 3], EditTagAdd: [TagName: [Const: foo, FormatString: [Const: bar]]]]',
    'Query: [LiftPropBy: [Const: test:int, Cmpr: =, Const: 3], FiltOper: [Const: +, TagCond: [TagMatch: [Const: foo, FormatString: [Const: bar]]]]]',
    'Query: [LiftPropBy: [Const: test:int, Cmpr: =, Const: 3], Return: [DollarExpr: [TagValue: [TagName: [Const: foo, FormatString: [Const: bar]]]]]]',
    ...
    'Query: [SetVarOper: [Const: bar, Const: baz], LiftPropBy: [Const: test:int, Cmpr: =, Const: 4], FiltOper: [Const: +, TagCond: [TagMatch: [FormatString: [Const: foo., VarValue: [Const: bar]]]]]]',
    'Query: [SetVarOper: [Const: bar, Const: baz], LiftPropBy: [Const: test:int, Cmpr: =, Const: 4], Return: [DollarExpr: [TagValue: [TagName: [FormatString: [Const: foo., VarValue: [Const: bar]]]]]]]',
    ...
    'Query: [SetVarOper: [Const: bar, Const: baz.faz], LiftPropBy: [Const: test:int, Cmpr: =, Const: 5], FiltOper: [Const: +, TagCond: [TagMatch: [FormatString: [Const: foo., VarValue: [Const: bar]]]]]]',
    'Query: [SetVarOper: [Const: bar, Const: baz.faz], LiftPropBy: [Const: test:int, Cmpr: =, Const: 5], Return: [DollarExpr: [TagValue: [TagName: [FormatString: [Const: foo., VarValue: [Const: bar]]]]]]]',
    ...
    'Query: [SetVarOper: [Const: bar, Const: baz.faz], LiftPropBy: [Const: test:int, Cmpr: =, Const: 6], FiltOper: [Const: +, TagCond: [TagMatch: [FormatString: [Const: foo., VarValue: [Const: bar]], Const: nice]]]]',
    'Query: [SetVarOper: [Const: bar, Const: baz.faz], LiftPropBy: [Const: test:int, Cmpr: =, Const: 6], Return: [DollarExpr: [TagValue: [TagName: [FormatString: [Const: foo., VarValue: [Const: bar]], Const: nice]]]]]',
    ...
    'Query: [SetVarOper: [Const: bar, Const: baz.faz], LiftPropBy: [Const: test:int, Cmpr: =, Const: 7], FiltOper: [Const: +, TagCond: [TagMatch: [Const: cool, FormatString: [Const: foo., VarValue: [Const: bar]]]]]]',
    'Query: [SetVarOper: [Const: bar, Const: baz.faz], LiftPropBy: [Const: test:int, Cmpr: =, Const: 7], Return: [DollarExpr: [TagValue: [TagName: [Const: cool, FormatString: [Const: foo., VarValue: [Const: bar]]]]]]]',
    ...
    'Query: [SetVarOper: [Const: bar, Const: baz.faz], LiftPropBy: [Const: test:int, Cmpr: =, Const: 8], FiltOper: [Const: +, TagCond: [TagMatch: [Const: cool, FormatString: [Const: foo., VarValue: [Const: bar]]]]]]',
    'Query: [SetVarOper: [Const: bar, Const: baz.faz], LiftPropBy: [Const: test:int, Cmpr: =, Const: 8], Return: [DollarExpr: [TagValue: [TagName: [Const: cool, FormatString: [Const: foo., VarValue: [Const: bar]]]]]]]',
]
...
class GrammarTest(s_t_utils.SynTest):
    ...
    def test_mode_storm(self):
        ...
        self.eq(str(tree), 'Query: [LiftPropBy: [Const: inet:fqdn, Cmpr: =, Const: vertex.link]]')
