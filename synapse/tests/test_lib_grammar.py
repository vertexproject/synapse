...
_ParseResults = [
    ...
    'Query: [LiftPropBy: [Const: media:news, Const: =, Const: 0c7f7267d3b62432cb0d7d0e9d3108a4], N1Walk: [Const: refs, Const: inet:ip], isjoin=False]',
    ...
    "Query: [LiftPropBy: [Const: geo:place, Const: =, Const: abcd], SetVarOper: [Const: latlong, RelPropValue: [RelProp: [Const: latlong]]], SetVarOper: [Const: radius, RelPropValue: [RelProp: [Const: radius]]], CmdOper: [Const: spin, Const: ()], LiftPropBy: [Const: tel:mob:telem:latlong, ByNameCmpr: (['near'], '='), List: [VarValue: [Const: latlong], Const: 3km]]]",
    ...
    'Query: [LiftPropBy: [Const: inet:dns:a, Const: =, List: [Const: woot.com, Const: 1.2.3.4]], SetVarOper: [Const: newp, RelPropValue: [UnivProp: [Const: .seen]]]]',
    'Query: [LiftPropBy: [Const: inet:dns:a, Const: =, List: [Const: woot.com, Const: 1.2.3.4]], SetVarOper: [Const: seen, RelPropValue: [UnivProp: [Const: .seen]]], PropPivot: [RelPropValue: [RelProp: [Const: fqdn]], PivotTarget: [Const: inet:fqdn]], isjoin=False, EditPropSet: [UnivProp: [Const: .seen], Const: =, VarValue: [Const: seen]]]',
    ...
    'Query: [LiftProp: [Const: inet:fqdn], FiltOper: [Const: +, TagCond: [TagMatch: [Const: bad]]], SetVarOper: [Const: fqdnbad, TagValue: [TagName: [Const: bad]]], FormPivot: [PivotTarget: [Const: inet:dns:a:fqdn]], isjoin=False, FiltOper: [Const: +, RelPropCond: [RelPropValue: [UnivProp: [Const: .seen]], Const: @=, VarValue: [Const: fqdnbad]]]]',
    ...
    'Query: [LiftPropBy: [Const: meta:seen:meta:source, Const: =, VarValue: [Const: sorc]], PropPivotOut: [RelPropValue: [RelProp: [Const: node]]], isjoin=False]',
    ...
    'Query: [LiftPropBy: [Const: ps:person, Const: =, VarValue: [Const: pers]], FormPivot: [PivotTarget: [Const: meta:seen]], isjoin=False, PivotOut: [], isjoin=False]',
    'Query: [LiftPropBy: [Const: ps:person, Const: =, VarValue: [Const: pers]], FormPivot: [PivotTarget: [Const: meta:seen]], isjoin=False, FormPivot: [PivotTarget: [Const: geo:place]], isjoin=False]',
    'Query: [LiftPropBy: [Const: ps:person, Const: =, VarValue: [Const: pers]], FormPivot: [PivotTarget: [Const: meta:seen]], isjoin=False, FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: time]], Const: @=, List: [Const: 2014, Const: 2017]]], FormPivot: [PivotTarget: [Const: geo:place]], isjoin=False]',
    'Query: [LiftPropBy: [Const: ps:person, Const: =, VarValue: [Const: pers]], FormPivot: [PivotTarget: [Const: meta:seen]], isjoin=False, PivotOut: [], isjoin=False]',
    'Query: [LiftPropBy: [Const: ps:person, Const: =, VarValue: [Const: pers]], FormPivot: [PivotTarget: [Const: meta:seen]], isjoin=False, PropPivotOut: [RelPropValue: [RelProp: [Const: node]]], isjoin=False]',
    ...
    'Query: [LiftPropBy: [Const: test:pivcomp, Const: =, List: [Const: hehe, Const: haha]], SetVarOper: [Const: ticktock, TagValue: [TagName: [Const: foo]]], FormPivot: [PivotTarget: [Const: test:pivtarg]], isjoin=False, FiltOper: [Const: +, RelPropCond: [RelPropValue: [UnivProp: [Const: .seen]], Const: @=, VarValue: [Const: ticktock]]]]',
    ...
    "Query: [LiftPropBy: [Const: test:str, Const: =, Const: a], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: tick]], ByNameCmpr: (['range'], '='), List: [Const: 20000101, Const: 20101201]]]]",
    ...
    'Query: [LiftPropBy: [Const: test:str, Const: =, Const: foobar], FormPivot: [PivotTarget: [Const: meta:seen]], isjoin=True]',
    'Query: [LiftPropBy: [Const: test:str, Const: =, Const: foobar], FormPivot: [PivotTarget: [Const: meta:seen]], isjoin=False, PivotIn: [], isjoin=True]',
    'Query: [LiftPropBy: [Const: test:str, Const: =, Const: foobar], FormPivot: [PivotTarget: [Const: meta:seen]], isjoin=False, PivotIn: [], isjoin=False]',
    ...
    'Query: [LiftPropBy: [Const: inet:ip, Const: =, Const: 1], SetVarOper: [Const: foo, RelPropValue: [UnivProp: [Const: .created]]], SetVarOper: [Const: bar, DollarExpr: [ExprNode: [VarValue: [Const: foo], Const: +, Const: 1]]]]',
    ...
    'Query: [LiftPropBy: [Const: test:str, Const: =, Const: foobar], FormPivot: [PivotTarget: [Const: inet:dns:*]], isjoin=False]',
    'Query: [LiftPropBy: [Const: test:str, Const: =, Const: foobar], FormPivot: [List: [PivotTarget: [Const: meta:seen], PivotTarget: [Const: inet:dns:a]]], isjoin=False]',
    'Query: [LiftPropBy: [Const: test:str, Const: =, Const: foobar], FormPivot: [List: [PivotTarget: [Const: meta:seen], PivotTarget: [Const: inet:dns*]]], isjoin=False]',
    ...
    'Query: [LiftPropBy: [Const: test:str, Const: =, Const: foobar], FormPivot: [PivotTarget: [Const: inet:dns:*]], isjoin=True]',
    'Query: [LiftPropBy: [Const: test:str, Const: =, Const: foobar], FormPivot: [List: [PivotTarget: [Const: meta:seen], PivotTarget: [Const: inet:dns:a]]], isjoin=True]',
    'Query: [LiftPropBy: [Const: test:str, Const: =, Const: foobar], FormPivot: [List: [PivotTarget: [Const: meta:seen], PivotTarget: [Const: inet:dns*]]], isjoin=True]',
    ...
    'Query: [LiftPropBy: [Const: inet:fqdn, Const: =, Const: foo.com], PropPivot: [RelPropValue: [RelProp: [Const: zone]], List: [PivotTarget: [Const: meta:seen], PivotTarget: [Const: inet:dns:a]]], isjoin=False]',
    ...
    'Query: [LiftPropBy: [Const: inet:fqdn, Const: =, Const: foo.com], PropPivot: [RelPropValue: [RelProp: [Const: zone]], List: [PivotTarget: [Const: meta:seen], PivotTarget: [Const: inet:dns:a]]], isjoin=True]',
