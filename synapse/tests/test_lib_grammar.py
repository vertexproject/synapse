...
Queries = [
    ...
    '[inet:ip=1.2.3.4 :asn=10] [meta:seen=(abcd, (inet:asn, 10))]',
...
_ParseResults = [
    ...
    'Query: [EditNodeAdd: [FormName: [Const: inet:ip], Const: =, Const: 1.2.3.4], EditPropSet: [RelProp: [Const: asn], Const: =, Const: 10], EditNodeAdd: [FormName: [Const: meta:seen], Const: =, List: [Const: abcd, List: [Const: inet:asn, Const: 10]]]]',
    ...
    "Query: [LiftProp: [Const: meta:seen], FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: node]], ByNameCmpr: (['range'], '='), List: [List: [Const: test:comp, List: [Const: 1000, Const: green]], List: [Const: test:comp, List: [Const: 3000, Const: ham]]]]]]",
    ...
    'Query: [LiftPropBy: [Const: meta:seen:meta:source, Cmpr: =, VarValue: [Const: sorc]], PivotOut: [], isjoin=False]',
    'Query: [LiftPropBy: [Const: meta:seen:meta:source, Cmpr: =, VarValue: [Const: sorc]], PropPivotOut: [RelPropValue: [RelProp: [Const: node]]], isjoin=False]',
    ...
    'Query: [LiftPropBy: [Const: ps:person, Cmpr: =, VarValue: [Const: pers]], FormPivot: [PivotTarget: [Const: meta:seen]], isjoin=False, PivotOut: [], isjoin=False]',
    'Query: [LiftPropBy: [Const: ps:person, Cmpr: =, VarValue: [Const: pers]], FormPivot: [PivotTarget: [Const: meta:seen]], isjoin=False, FormPivot: [PivotTarget: [Const: geo:place]], isjoin=False]',
    'Query: [LiftPropBy: [Const: ps:person, Cmpr: =, VarValue: [Const: pers]], FormPivot: [PivotTarget: [Const: meta:seen]], isjoin=False, FiltOper: [Const: +, RelPropCond: [RelPropValue: [RelProp: [Const: time]], Cmpr: @=, List: [Const: 2014, Const: 2017]]], FormPivot: [PivotTarget: [Const: geo:place]], isjoin=False]',
    'Query: [LiftPropBy: [Const: ps:person, Cmpr: =, VarValue: [Const: pers]], FormPivot: [PivotTarget: [Const: meta:seen]], isjoin=False, PivotOut: [], isjoin=False]',
    'Query: [LiftPropBy: [Const: ps:person, Cmpr: =, VarValue: [Const: pers]], FormPivot: [PivotTarget: [Const: meta:seen]], isjoin=False, PropPivotOut: [RelPropValue: [RelProp: [Const: node]]], isjoin=False]',
    ...
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foobar], FormPivot: [PivotTarget: [Const: meta:seen]], isjoin=True]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foobar], FormPivot: [PivotTarget: [Const: meta:seen]], isjoin=False, PivotIn: [], isjoin=True]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foobar], FormPivot: [PivotTarget: [Const: meta:seen]], isjoin=False, PivotIn: [], isjoin=False]',
    ...
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foobar], FormPivot: [PivotTarget: [Const: inet:dns:*]], isjoin=False]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foobar], FormPivot: [List: [PivotTarget: [Const: meta:seen], PivotTarget: [Const: inet:dns:a]]], isjoin=False]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foobar], FormPivot: [List: [PivotTarget: [Const: meta:seen], PivotTarget: [Const: inet:dns*]]], isjoin=False]',
    ...
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foobar], FormPivot: [PivotTarget: [Const: inet:dns:*]], isjoin=True]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foobar], FormPivot: [List: [PivotTarget: [Const: meta:seen], PivotTarget: [Const: inet:dns:a]]], isjoin=True]',
    'Query: [LiftPropBy: [Const: test:str, Cmpr: =, Const: foobar], FormPivot: [List: [PivotTarget: [Const: meta:seen], PivotTarget: [Const: inet:dns*]]], isjoin=True]',
    ...
    'Query: [LiftPropBy: [Const: inet:fqdn, Cmpr: =, Const: foo.com], PropPivot: [RelPropValue: [RelProp: [Const: zone]], List: [PivotTarget: [Const: meta:seen], PivotTarget: [Const: inet:dns:a]]], isjoin=False]',
    ...
    'Query: [LiftPropBy: [Const: inet:fqdn, Cmpr: =, Const: foo.com], PropPivot: [RelPropValue: [RelProp: [Const: zone]], List: [PivotTarget: [Const: meta:seen], PivotTarget: [Const: inet:dns:a]]], isjoin=True]',
