...
_ParseResults = [
    ...
    'Query: [LiftPropBy: [Const: test:guid, Cmpr: =, Const: 0c7f7267d3b62432cb0d7d0e9d3108a4], N1Walk: [Const: refs, Const: inet:ip], isjoin=False]',
    ...
    'Query: [LiftPropBy: [Const: inet:fqdn, Cmpr: =, Const: woot.com], EditEdgeAdd: [Const: refs, SubQuery: [Query: [LiftProp: [Const: test:guid]]]]]',
    'Query: [LiftPropBy: [Const: inet:fqdn, Cmpr: =, Const: woot.com], EditEdgeAdd: [Const: refs, SubQuery: [Query: [LiftProp: [Const: test:guid]]]]]',
    ...
    'Query: [LiftProp: [Const: test:guid], EditEdgeDel: [Const: refs, SubQuery: [Query: [LiftPropBy: [Const: inet:fqdn, Cmpr: =, Const: woot.com]]]]]',
    'Query: [LiftProp: [Const: test:guid], EditEdgeAdd: [Const: refs, SubQuery: [Query: [LiftPropBy: [Const: inet:fqdn, Cmpr: =, Const: woot.com]]]]]',
    ...
    'Query: [LiftPropBy: [Const: test:guid, Cmpr: =, Const: 00a1f0d928e25729b9e86e2d08c127ce], EditPropSet: [RelProp: [Const: summary], Const: =, Const: ]]',
