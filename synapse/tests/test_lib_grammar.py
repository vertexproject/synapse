...
_ParseResults = [
    ...
    'Query: [EditPropSet: [UnivProp: [Const: .seen], Const: ?=, DollarExpr: [ExprNode: [RelPropValue: [RelProp: [Const: foo], VirtProps: [VirtProp: [Const: virt]]], Const: *, Const: 1000]]]]',
    ...
    'Query: [SetVarOper: [Const: foo, DollarExpr: [UnaryExprNode: [Const: not, DollarExpr: [VarValue: [Const: x]]]]]]',
    'Query: [EditCondPropSet: [RelProp: [Const: foo], VirtSetOper: [Const: precision], Const: day]]',
    'Query: [EditCondPropSet: [RelProp: [VarValue: [Const: foo]], VirtSetOper: [Const: precision], Const: day]]',
    'Query: [EditCondPropSet: [UnivProp: [Const: .foo], VirtSetOper: [Const: precision], Const: day]]',
    ...
    'Query: [EditCondPropSet: [UnivProp: [VarValue: [Const: foo]], VirtSetOper: [Const: precision], Const: day]]',
