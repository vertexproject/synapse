...
def test_ingest_outvar(self):
    ...
    with s_cortex.openurl('ram://') as core:
            ...
            self.assertIsNotNone(core.getTufoByProp('file:bytes:sha256', 'd7a8fbb307d7809469ca9abcb0082e4f8d5651e46d3cdb762d02d0bf37c9e592'))
            self.assertIsNotNone(core.getTufoByProp('it:av:filehit:sig', 'memesec/meme32.lazydog'))
            self.assertIsNotNone(core.getTufoByProp('it:av:sig:sig', 'meme32.lazydog'))
            self.assertIsNotNone(core.getTufoByProp('file:bytes:sha256', 'ef537f25c895bfa782526529a9b63d97aa631564d5d789c2b765448c8635fb6c'))
            self.assertIsNotNone(core.getTufoByProp('it:av:filehit:sig', 'memesec/meme32.lazydog.puntuation'))
            self.assertIsNotNone(core.getTufoByProp('it:av:sig:sig', 'meme32.lazydog.puntuation'))
            self.assertEqual(len(core.getTufosByProp('it:av:sig:org', 'memesec')), 2)
