    ...
    def test_ou_simple(self):
        with self.getTestCore() as core:
            ...
            with core.xact(write=True) as xact:
                ...
                node = xact.addNode('ou:member', (guid0, person0), mprops)
                ...
                node = xact.addNode('ou:meet:attendee', (m0, person0), mprops)
                ...
                node = xact.addNode('ou:conference:attendee', (c0, person0), cprops)
