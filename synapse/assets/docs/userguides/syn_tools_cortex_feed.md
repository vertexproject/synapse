...
usage: synapse.tools.cortex.feed [-h] (--cortex CORTEX | --test) [--summary]
...
positional arguments:
  files                 json/yaml/msgpack feed files

options:
  -h, --help            show this help message and exit
  --cortex, -c CORTEX   Cortex to connect and add nodes too.
  --test, -t            Perform a local ingest against a temporary cortex.
  --summary, -s         Show a summary of the data. Do not add any data.
  --debug, -d           Drop to interactive prompt to inspect cortex after
                        loading data.
  --chunksize CHUNKSIZE
                        Default chunksize for iterating over items.
  --offset OFFSET       Item offset to start consuming data from.
  --view VIEW           The View to ingest the data into.

```

> [!NOTE]
> This tool was previously run using `synapse.tools.feed`, which was removed in Synapse 3.0.0. See [CLI Tool Changes](../300_changes/devops-cli-tools.md#vtx_300_devops-cli-tools).
