...
<a id="conf-aha-promotable"></a>

#### aha:promotable

Set to false to prevent this service from being promoted to leader.
...
`SYN_AHA_AHA_PROMOTABLE`

<a id="conf-aha-provision"></a>
...
<a id="conf-aha-servers"></a>

#### aha:servers

A list of telepath URLs for the aha service registry.
...
<a id="conf-auth-passwd-policy"></a>
...
<a id="conf-dns-name"></a>

#### dns:name

The registered DNS name used to reach the AHA service. This is required.
...
<a id="conf-health-sysctl-checks"></a>
...
<a id="conf-https-parse-proxy-remoteip"></a>
...
A telepath URL of our upstream/parent. This overrides AHA selection.
...
<a id="conf-safemode"></a>

#### safemode

Boot the service in safe-mode.
...
<a id="conf-telepath-port"></a>

#### telepath:port

A config-driven way to specify the telepath listening port while inheriting the provisioned hostname and CA. Takes precedence over the port in dmon:listen.
...
`SYN_AXON_TELEPATH_PORT`

<a id="conf-tls-ca-dir"></a>
...
<a id="conf-layers-cache-size"></a>

#### layers:cache:size

Default nid cache size for new layers.
...
<a id="conf-storm-interface-scrape"></a>
