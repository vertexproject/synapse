    ...
    def getModelDefs(self):
        modl = {
            'types': (
                ...
                ('ps:vitals', ('guid', {}), {
                    'doc': 'Statistics and demographic data about an individual'}),

                ('ps:skill', ('guid', {}), {
                    # FIXME should orgs have skills? Update to entity?
            ...
            'forms': (
                ('ps:workhist', {}, (
                    ...
                    # FIXME does one always work for an org?
                    # FIXME rename to :employer in any case
                    ('org', ('ou:org', {}), {
                        'doc': 'The org that this work history refers to.'}),

                    ('org:name', ('entity:name', {}), {
                        'doc': 'The name of the org that this work history refers to.'}),
                    # FIXME other entity res props...
                    ...
                    ('period', ('ival', {}), {
                        'doc': 'The period when the contact worked for the employer.'}),
                    ...
                    # FIXME should these be part of an interface?
                    ('pay', ('econ:price', {}), {
                ...
                ('edu:class', {}, (
                    ...
                    ('period', ('ival', {}), {
                        'doc': 'The time period where the class was run.'}),
                ...
                ('ps:education', {}, (
                    ...
                    ('period', ('ival', {}), {
                        'doc': 'The period where the student attended classes.'}),
                ...
                ('ps:contact', {}, (
                    # FIXME ps:contact no longer represents a person
                    #('org', ('ou:org', {}), {
                        #'doc': 'The org which this contact represents.',
                    #}),
                    # FIXME port all old contact types to unified taxonomy
                    ...
                    # FIXME does this become "employer" and use entity protocol?
                    ('orgname', ('ou:name', {}), {
                    ...
                    # FIXME perhaps we should invert and make an id:number an entity:contact:info?
                    ('id:number', ('ou:id:number', {}), {
                        'doc': 'An ID number issued by an org and associated with this contact.',
                    }),

                    # FIXME are these still how we want to track this? maybe tel:subscriber?
                    ('adid', ('it:adid', {}), {
