        ...
        'types': (
            ...
            ('crypto:currency:transaction', ('guid', {}), {
                'props': (
                    ...
                    ('fee:limit', ('econ:price', {}), {
                        'doc': 'The maximum fee allowed to execute the transaction.'}),
                    ('fee:asked', ('econ:price', {}), {
                        'doc': 'The fee requested to execute the transaction.'}),
                    ('value', ('econ:price', {}), {
            ...
            ('crypto:smart:effect:proxytokens', ('guid', {}), {
                ...
                'props': (
                    ...
                    ('amount', ('hugenum', {}), {
                        'doc': 'The amount of tokens the proxy is allowed to manipulate.'}),
                ),
            ...
            ('crypto:currency:address', ('comp', {'fields': (('chain', 'crypto:currency:chain'), ('iden', 'str')), 'sepr': '/'}), {

                'template': {'title': 'crypto currency address'},
                'interfaces': (
                    ('econ:pay:instrument', {}),
                    ('meta:observable', {}),
                ),
                'props': (
                    ...
                    ('iden', ('str', {}), {
                        'computed': True,
                        'doc': 'The chain specific address identifier.'}),
            ...
            ('crypto:currency:client', ('comp', {'fields': (
                ...
                'template': {'title': 'crypto currency address and Internet client'},
                'interfaces': (
                    ('meta:observable', {}),
                ),
            ...
            ('crypto:x509:cert', ('guid', {}), {
                'template': {'title': 'X.509 certificate'},
                'interfaces': (
                    ('meta:observable', {}),
                ),
                'props': (
                    ...
                    ('selfsigned', ('bool', {}), {
                        'doc': 'Set to true if the certificate is self-signed.',
                    }),
            ...
            ('crypto:x509:rdn', ('comp', {'fields': (('name', 'str:upper'), ('value', 'title')), 'sepr': '='}), {
                'props': (
                    ('name', ('str:upper', {}), {
                        'doc': 'The RDN attribute name.', 'computed': True}),
                    ('value', ('title', {}), {
                        'doc': 'The RDN attribute value.', 'computed': True}),
                ),
                'doc': 'An X.509 Relative Distinguished Name (RDN) attribute and value pair.'}),
            ...
            ('crypto:key', {
                'props': (
                    ...
                    ('algorithm', ('meta:algorithm', {}), {
                        'doc': 'The algorithm which uses the key material.'}),
                ),
