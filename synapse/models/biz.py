    ...
    def getModelDefs(self):
        modl = {
            'types': (
                ...
                # FIXME deprecate and allow product trees
                ('biz:bundle', ('guid', {}), {
            ...
            'forms': (
                ...
                ('biz:rfp', {}, (
                    ...
                    # FIXME ou:goal -> ou:requirement
                    #('requirements', ('array', {'type': 'ou:goal', 'uniq': True, 'sorted': True}), {}),
                    ('requirements', ('array', {'type': 'ou:requirement', 'uniq': True, 'sorted': True}), {}),
                )),
                ('biz:deal', {}, (
                    ('title', ('str', {}), {
                ...
                ('biz:listing', {}, (
                    ...
                    # FIXME convert product/service to an ndef and :selling (or something)
                    ('product', ('biz:product', {}), {
                ...
                ('biz:product', {}, (
                    ...
                    # FIXME move to :includes as an array of ndefs?
