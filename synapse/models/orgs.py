modeldefs = (
    {
        ...
        'types': (
            ('ou:sic', ('base:id', {'regex': r'^[0-9]{4}$'}), {
                'props': (),
                'ex': '0111',
                'doc': 'A four digit Standard Industrial Classification (SIC) code.'}),

            ('ou:naics', ('base:id', {'regex': r'^[1-9][0-9]{1,5}?$'}), {
                'props': (),
                'ex': '541715',
                'doc': 'North American Industry Classification System (NAICS) codes and prefixes.'}),

            ('ou:isic', ('base:id', {'regex': r'^[A-Z]([0-9]{2}[0-9]{0,2})?$'}), {
                'props': (),
                'ex': 'C1393',
            ...
            ('ou:id', ('guid', {}), {
                ...
                'props': (
                    ...
                    ('issued', ('date', {}), {
                        'doc': 'The date the ID was initially issued.'}),

                    ('updated', ('time', {}), {
                        'doc': 'The time when the ID was most recently updated.'}),

                    ('expires', ('date', {}), {
                        'doc': 'The date the ID expires.'}),
            ...
            ('ou:enacted', ('guid', {}), {
                ...
                'props': (
                    ...
                    ('scope', (
                        ...
                        'doc': 'The scope of responsibility for the assignee to enact the document.'}),
                ),
