    ...
    def getModelDefs(self):
        return (('sci', {
            ...
            'edges': (
                ...
                (('risk:tool:software', 'uses', 'sci:algorithm'), {
                    'doc': 'The tool uses the algorithm.'}),
                (('it:prod:software', 'uses', 'sci:algorithm'), {
                    'doc': 'The software uses the algorithm.'}),
                (('file:bytes', 'uses', 'sci:algorithm'), {
                    'doc': 'The file uses the algorithm.'}),
                (('sci:algorithm', 'generated', None), {
                    'doc': 'The target node was generated by the algorithm.'}),
            ),

            'forms': (
                # TODO many of these forms need author/contact props
                ('sci:algorithm:type:taxonomy', {}, (
                ('sci:algorithm', {}, (
                    ('name', ('str', {'lower': True, 'onespace': True}), {
                        'doc': 'The name of the algorithm.'}),
                    ('type': ('sci:algorithm:type:taxonomy', {}), {
                        'doc': 'The type of algorithm.'}),
                    ('desc', ('str', {'lower': True, 'onespace': True}), {
                        'disp': {'hint': 'text'},
                        'doc': 'A description of the algorithm.'}),
                    ('created', ('time', {}), {
                        'doc': 'The time that the algorithm was authored or discovered.'}),
                    ('author', ('ps:contact', {}), {
                        'doc': 'The contact who authored or discovered the algorithm.'}),
                )),
