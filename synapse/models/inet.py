...
modeldefs = (
    ('inet', {
        'ctors': (
            ...
            ('inet:ip', 'synapse.lib.types.IPAddr', {}, {
                'interfaces': (
            ...
            ('inet:net', 'synapse.lib.types.IPRange', {}, {
                'ex': '1.2.3.4-1.2.3.8',
                'virts': (
                    ('mask', ('int', {}), {
                        'computed': True,
            ...
            ('inet:sockaddr', 'synapse.lib.types.SockAddr', {}, {
                'ex': 'tcp://1.2.3.4:80',
                'virts': (
                    ('ip', ('inet:ip', {}), {
                        'computed': True,
            ...
            ('inet:email', 'synapse.lib.types.Email', {}, {
                'interfaces': (
                    ('meta:observable', {'template': {'title': 'email address'}}),
                ),
                'doc': 'An email address.'}),

            ('inet:fqdn', 'synapse.lib.types.Fqdn', {}, {
                'interfaces': (
            ...
            ('inet:rfc2822:addr', 'synapse.lib.types.Rfc2822Addr', {}, {
                'interfaces': (
            ...
            ('inet:url', 'synapse.lib.types.Url', {}, {
                'interfaces': (
            ...
            ('inet:http:cookie', 'synapse.lib.types.HttpCookie', {}, {
        ...
        'forms': (
            ...
            ('inet:ip', {
                ...
                ('scope', ('str', {'enums': s_types.scopes_enum}), {
