...
TerminalPygMap = {
    ...
    'JSONHEX': p_t.Literal.Number,
    'JSONNUMBER': p_t.Literal.Number,
    'JSONOCT': p_t.Literal.Number,
    'IF': p_t.Keyword,
    'IN': p_t.Keyword,
    ...
    'UNSET': p_t.Operator,
    'CONDMIN': p_t.Operator,
    'CONDMAX': p_t.Operator,
