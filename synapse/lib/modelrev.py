...
class ModelRev:
    ...
    async def revModel_0_2_23(self, layers):
        ...
        # normalizing subs based on the value of a secondary property (:v2_2 in this case).
        ...
        for layr in layers:
            ...
            genr = layr.liftByProp(form.name, 'v2_2')
            ...
            async for _, buid, sode in genr:
                ...
                if norm != formvalu:
                    ...
                    mesg = f'Unable to migrate primary property for it:sec:cpe="{formvalu}" (iden: {iden}). Continuing to migrate secondary properties.'
                    logger.warning(mesg)
