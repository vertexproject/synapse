...
EDIT_PROP_OVERWRITE = 24
EDIT_TAG_OVERWRITE = 25
...
class Layer(s_nexus.Pusher):
    ...
    def getEdgeVerbCount(self, verb, n1form=None, n2form=None):
        ...
        try:
            ...
            if n1form is not None:
                n1abrv = self.core.setIndxAbrv(INDX_FORM, n1form)

            if n2form is not None:
                n2abrv = self.core.setIndxAbrv(INDX_FORM, n2form)
    ...
    async def _calcPropOverwrite(self, nid, edit, sode, newsode):
    ...
    async def _calcTagOverwrite(self, nid, edit, sode, newsode):
