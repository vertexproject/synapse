...
stormcmds = (
    ...
    },
    {
        ...
        'descr': '''
            ...
            Examples:
                ...
                // add 000.cortex... to the existing pool named pool.cortex
                aha.pool.svc.add pool.cortex... 000.cortex...
        ''',
        'cmdargs': (
    ...
    },
    {
        ...
        'storm': '''
            ...
            $svcname = $pool.del($cmdopts.svcname)
            if $svcname {
                $lib.print(`AHA service ({$svcname}) removed from service pool ({$pool.name})`)
            } else {
