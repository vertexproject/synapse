...
```mdinclude
../../../examples/power-ups/rapid/acme-hello/storm/modules/acme.hello.privsep.storm
```
...
```mdinclude
../../../examples/power-ups/rapid/acme-hello/storm/commands/acme.hello.omgopts.storm
```
...
```mdinclude --code python3
../../../examples/power-ups/rapid/acme-hello/test_acme_hello.py
```
...
```mdinclude
../../../examples/power-ups/rapid/acme-hello/storm/commands/acme.hello.mayyield.storm
```
